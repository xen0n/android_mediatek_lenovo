...
#Lenovo-sw weimh1 add 2014-4-30 begin:add mtxgen.log
MTXGEN_LOG    =  $(LOGDIR)/$(PROJECT)_mtxgen.log
#Lenovo-sw weimh1 add 2014-4-30 end
...
#Lenovo-sw weimh1 add 2014-4-30 begin:add MTXGEN_LOG
...
#############################################################
# mtx.pl build
# Lenovo-sw weimh1 2014.4.30 add
#############################################################
mtxgen:
