...
#Begin,Lenovo-sw zhuan1 20140331,add for fuse
ifeq ($(LENOVO_SHARED_SDCARD),yes)
  PRODUCT_COPY_FILES += $(MTK_ROOT_CONFIG_OUT)/init.fuse.rc:root/init.fuse.rc
else
...
#End,Lenovo-sw zhuan1 20140331,add for fuse



########INSTALL Speaker and SmartPA parameters ########
ifeq ($(strip $(NXP_SMARTPA_SUPPORT)),tfa9890)
PRODUCT_COPY_FILES += $(MTK_ROOT_CONFIG_OUT)/smartpa_params/TFA9890_eq.eq:system/etc/smartpa_params/TFA9890_eq.eq
PRODUCT_COPY_FILES += $(MTK_ROOT_CONFIG_OUT)/smartpa_params/TFA9890_preset.preset:system/etc/smartpa_params/TFA9890_preset.preset
PRODUCT_COPY_FILES += $(MTK_ROOT_CONFIG_OUT)/smartpa_params/TFA9890_config.config:system/etc/smartpa_params/TFA9890_config.config
PRODUCT_COPY_FILES += $(MTK_ROOT_CONFIG_OUT)/smartpa_params/TFA9890_patch.patch:system/etc/smartpa_params/TFA9890_patch.patch
PRODUCT_COPY_FILES += $(MTK_ROOT_CONFIG_OUT)/smartpa_params/TFA9890_speaker.speaker:system/etc/smartpa_params/TFA9890_speaker.speaker
PRODUCT_COPY_FILES += $(MTK_ROOT_CONFIG_OUT)/smartpa_params/coldboot.patch:system/etc/smartpa_params/coldboot.patch
PRODUCT_COPY_FILES += $(MTK_ROOT_CONFIG_OUT)/smartpa_params/devkit_Release.parms:system/etc/smartpa_params/devkit_Release.parms
endif
...
##### INSTALL thermalstress.cfg ##########

_thermalstress_cfg := $(MTK_ROOT_CONFIG_OUT)/configs/thermalstress.cfg
ifneq ($(wildcard $(_thermalstress_cfg)),)
PRODUCT_COPY_FILES += $(_thermalstress_cfg):system/etc/.tp/thermalstress.cfg
endif
