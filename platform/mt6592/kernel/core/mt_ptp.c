...
static void PTP_set_ptp_volt(void)
{
    ...
    if (freq_0 != 0)
    {
        ...
        if (ptpod_pmic_volt[0] > 0x54)
        {
            ptpod_pmic_volt[0] = 0x54;
        }
        else
        {
            #if defined(IS_VCORE_USE_6333VCORE)
            if (ptpod_pmic_volt[0] < 0x20)
            {
                ptpod_pmic_volt[0] = 0x20;
            }
            #else
            if (ptpod_pmic_volt[0] < 0x30)
            {
                ptpod_pmic_volt[0] = 0x30;
            }
            #endif
        }
    ...
    if (freq_1 != 0)
    {
        ...
        if (ptpod_pmic_volt[1] > 0x54)
        {
            ptpod_pmic_volt[1] = 0x54;
        }
        else
        {
            #if defined(IS_VCORE_USE_6333VCORE)
            if (ptpod_pmic_volt[1] < 0x20)
            {
                ptpod_pmic_volt[1] = 0x20;
            }
            #else
            if (ptpod_pmic_volt[1] < 0x30)
            {
                ptpod_pmic_volt[1] = 0x30;
            }
            #endif
        }
        ptp_array_size++;
    ...
    if (freq_2 != 0)
    {
        ...
        if (ptpod_pmic_volt[2] > 0x54)
        {
            ptpod_pmic_volt[2] = 0x54;
        }
        else
        {
            #if defined(IS_VCORE_USE_6333VCORE)
            if (ptpod_pmic_volt[2] < 0x20)
            {
                ptpod_pmic_volt[2] = 0x20;
            }
            #else
            if (ptpod_pmic_volt[2] < 0x30)
            {
                ptpod_pmic_volt[2] = 0x30;
            }
            #endif
        }
        ptp_array_size++;
    ...
    if (freq_3 != 0)
    {
        ...
        if (ptpod_pmic_volt[3] > 0x54)
        {
            ptpod_pmic_volt[3] = 0x54;
        }
        else
        {
            #if defined(IS_VCORE_USE_6333VCORE)
            if (ptpod_pmic_volt[3] < 0x20)
            {
                ptpod_pmic_volt[3] = 0x20;
            }
            #else
            if (ptpod_pmic_volt[3] < 0x30)
            {
                ptpod_pmic_volt[3] = 0x30;
            }
            #endif
        }
        ptp_array_size++;
    ...
    if (freq_4 != 0)
    {
        ...
        if (ptpod_pmic_volt[4] > 0x54)
        {
            ptpod_pmic_volt[4] = 0x54;
        }
        else
        {
            #if defined(IS_VCORE_USE_6333VCORE)
            if (ptpod_pmic_volt[4] < 0x20)
            {
                ptpod_pmic_volt[4] = 0x20;
            }
            #else
            if (ptpod_pmic_volt[4] < 0x30)
            {
                ptpod_pmic_volt[4] = 0x30;
            }
            #endif
        }
        ptp_array_size++;
    ...
    if (freq_5 != 0)
    {
        ...
        if (ptpod_pmic_volt[5] > 0x54)
        {
            ptpod_pmic_volt[5] = 0x54;
        }
        else
        {
            #if defined(IS_VCORE_USE_6333VCORE)
            if (ptpod_pmic_volt[5] < 0x20)
            {
                ptpod_pmic_volt[5] = 0x20;
            }
            #else
            if (ptpod_pmic_volt[5] < 0x30)
            {
                ptpod_pmic_volt[5] = 0x30;
            }
            #endif
        }
        ptp_array_size++;
    ...
    if (freq_6 != 0)
    {
        ...
        if (ptpod_pmic_volt[6] > 0x54)
        {
            ptpod_pmic_volt[6] = 0x54;
        }
        else
        {
            #if defined(IS_VCORE_USE_6333VCORE)
            if (ptpod_pmic_volt[6] < 0x20)
            {
                ptpod_pmic_volt[6] = 0x20;
            }
            #else
            if (ptpod_pmic_volt[6] < 0x30)
            {
                ptpod_pmic_volt[6] = 0x30;
            }
            #endif
        }
        ptp_array_size++;
    ...
    if (freq_7 != 0)
    {
        ...
        if (ptpod_pmic_volt[7] > 0x54)
        {
            ptpod_pmic_volt[7] = 0x54;
        }
        else
        {
            #if defined(IS_VCORE_USE_6333VCORE)
            if (ptpod_pmic_volt[7] < 0x20)
            {
                ptpod_pmic_volt[7] = 0x20;
            }
            #else
            if (ptpod_pmic_volt[7] < 0x30)
            {
                ptpod_pmic_volt[7] = 0x30;
            }
            #endif
        }
        ptp_array_size++;
...
static int ptp_probe(struct platform_device *pdev)
{
    ...
    if (!test_mode)
    {
        val_0 = get_devinfo_with_index(7);
        val_1 = get_devinfo_with_index(8);
        val_2 = get_devinfo_with_index(9);
        val_3 = get_devinfo_with_index(14);
    }
    #endif
...
****************************/
static int ptp_offset_read(char *buf, char **start, off_t off, int count, int *eof, void *data)
{
    int len = 0;
    char *p = buf;
...
*************************************/
static ssize_t ptp_offset_write(struct file *file, const char *buffer, unsigned long count, void *data)
{
    int offset = 0;

    if (sscanf(buffer, "%d", &offset) == 1)
    {
...
static char scramble(char efuse_data)
{
    int i = 0;
    char raw = 0, r[8];

    r[0] = (~(efuse_data) & 0x08) >> 3; // ~e3
    r[1] = (  efuse_data  & 0x10) >> 4; //  e4
    r[2] = (~(efuse_data) & 0x20) >> 5; // ~e5
    r[3] = (  efuse_data  & 0x40) >> 6; //  e6
    r[4] = (~(efuse_data) & 0x80) >> 7; // ~e7
    r[5] = (  efuse_data  & 0x01) >> 0; //  e0
    r[6] = (~(efuse_data) & 0x02) >> 1; // ~e1
    r[7] = (  efuse_data  & 0x04) >> 2; //  e2
...
static int ptp_dump_read(char *buf, char **start, off_t off, int count, int *eof, void *data)
{
    ...
    char *p = buf;
    char cpu_raw = 0, soc_raw = 0;
    char cpu_efuse = 0, soc_efuse = 0;

    cpu_efuse = (get_devinfo_with_index(26) & 0x0000FF00) >> 8;
    soc_efuse = (get_devinfo_with_index(26) & 0x000000FF);

    cpu_raw = scramble(cpu_efuse);
    soc_raw = scramble(soc_efuse);

    p += sprintf(p, "(0x%x, 0x%x, 0x%x, 0x%x) - (0x%x, 0x%x) - (%u, %u)\n", val_0, val_1, val_2, val_3, cpu_efuse, soc_efuse, cpu_raw, soc_raw);
...
static int __init ptp_init(void)
{
    ...
    else
    {
        ...
        entry = create_proc_entry("ptp_offset", S_IRUGO | S_IWUSR | S_IWGRP, dir);
        if (entry)
        {
            entry->read_proc = ptp_offset_read;
            entry->write_proc = ptp_offset_write;
        }
    }
