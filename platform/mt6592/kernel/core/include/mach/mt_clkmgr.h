...
#define VENCPLL_CON0        (APMIXEDSYS_BASE + 0x0250)
#define VENCPLL_CON1        (APMIXEDSYS_BASE + 0x0254)
#define VENCPLL_PWR_CON0    (APMIXEDSYS_BASE + 0x025C)

#define TVDPLL_CON0         (APMIXEDSYS_BASE + 0x0260)
#define TVDPLL_CON1         (APMIXEDSYS_BASE + 0x0264)
#define TVDPLL_CON3         (APMIXEDSYS_BASE + 0x026C)
#define TVDPLL_CON4         (APMIXEDSYS_BASE + 0x0270)
#define TVDPLL_PWR_CON0     (APMIXEDSYS_BASE + 0x0274)
...
#define MJC_CG_CON          (MJCSYS_CONFIG_BASE + 0x0000) //0xF7000000
#define MJC_CG_SET          (MJCSYS_CONFIG_BASE + 0x0004)
#define MJC_CG_CLR          (MJCSYS_CONFIG_BASE + 0x0008)
...
enum cg_clk_id{
    ...
    MT_CG_DISP0_RDMA1               = 115,
    MT_CG_DISP0_UFOE                = 116,
    ...
    MT_CG_MJC_SMI_LARB              = 320,
    MT_CG_MJC_TOP_GROUP0            = 321,
    MT_CG_MJC_TOP_GROUP1            = 322,
    MT_CG_MJC_TOP_GROUP2            = 323,


    CG_PERI_FROM                    = MT_CG_PERI_NFI,
    CG_PERI_TO                      = MT_CG_PERI_MSDC30_3,
    NR_PERI_CLKS                    = 27,
    ...
    CG_MJC_to                       = MT_CG_MJC_TOP_GROUP2,
    NR_MJC_CLKS                     = 4,
...
//extern void force_pwr_down(void);
