...
#define SPM_MP0_FC0_PWR_CON         (SPM_BASE + 0x0200)
#define SPM_MP0_DBG_PWR_CON         (SPM_BASE + 0x0204)
#define SPM_MP0_CPU_PWR_CON         (SPM_BASE + 0x0208)
...
#define SPM_MP0_L2_DAT_PDN          (SPM_BASE + 0x0244)
#define SPM_MP0_L2_DAT_SLEEP_B      (SPM_BASE + 0x0248)
#define SPM_VCA7_EXT_ISO            (SPM_BASE + 0x024c)
#define SPM_CPU_AUX                 (SPM_BASE + 0x0250)
#define SPM_MJC_MEM_PDN1            (SPM_BASE + 0x0254)
#define SPM_SRAM_SLEEPB_DEGLITCH    (SPM_BASE + 0x0258)
...
#define SPM_MJC_PWR_CON             (SPM_BASE + 0x0298)
...
#define SPM_MJC_MEM_PDN2            (SPM_BASE + 0x02B8)
...
#define SPM_MP1_CPU0_IRQ_MASK       (SPM_BASE + 0x0b40)
#define SPM_MP1_CPU1_IRQ_MASK       (SPM_BASE + 0x0b44)
#define SPM_MP1_CPU2_IRQ_MASK       (SPM_BASE + 0x0b48)
#define SPM_MP1_CPU3_IRQ_MASK       (SPM_BASE + 0x0b4c)
...
#define SPM_MP0_CORE0_WFI_SEL       (SPM_BASE + 0x0f00)
#define SPM_MP0_CORE1_WFI_SEL       (SPM_BASE + 0x0f04)
#define SPM_MP0_CORE2_WFI_SEL       (SPM_BASE + 0x0f08)
#define SPM_MP0_CORE3_WFI_SEL       (SPM_BASE + 0x0f0c)
#define SPM_MP1_CORE0_WFI_SEL       (SPM_BASE + 0x0f10)
#define SPM_MP1_CORE1_WFI_SEL       (SPM_BASE + 0x0f14)
#define SPM_MP1_CORE2_WFI_SEL       (SPM_BASE + 0x0f18)
#define SPM_MP1_CORE3_WFI_SEL       (SPM_BASE + 0x0f1c)
...
#define PCM_SW_INT_ALL              (PCM_SW_INT7 | PCM_SW_INT6 | PCM_SW_INT5 | PCM_SW_INT4 |  \
                                     PCM_SW_INT3 | PCM_SW_INT2 | PCM_SW_INT1 | PCM_SW_INT0)
...
#define WAKE_SRC_MP1_CPU3_IRQ       (1U << 23)
#define WAKE_SRC_SYSPWREQ           (1U << 24)
#define WAKE_SRC_MD_WDT             (1U << 25)
#define WAKE_SRC_MP0_CPU0_IRQ       (1U << 26)
#define WAKE_SRC_MP0_CPU1_IRQ       (1U << 27)
#define WAKE_SRC_MP0_CPU2_IRQ       (1U << 28)
#define WAKE_SRC_MP0_CPU3_IRQ       (1U << 29)
...
#define ISR_PCM_IRQ4                (1U << 12)
#define ISR_PCM_IRQ5                (1U << 13)
#define ISR_PCM_IRQ6                (1U << 14)
#define ISR_PCM_IRQ7                (1U << 15)

#define ISRM_PCM_IRQ_AUX            (ISR_PCM_IRQ7 | ISR_PCM_IRQ6 | ISR_PCM_IRQ5 | ISR_PCM_IRQ4 |   \
                                     ISR_PCM_IRQ3 | ISR_PCM_IRQ2 | ISR_PCM_IRQ1)
#define ISRM_ALL_EXC_TWAM           (ISR_PCM_IRQ7 | ISR_PCM_IRQ6 | ISR_PCM_IRQ5 | ISR_PCM_IRQ4 |   \
                                     ISR_PCM_IRQ3 | ISR_PCM_IRQ2 | ISR_PCM_IRQ1 | ISR_PCM_IRQ0 |   \
                                     ISR_PCM_RETURN)
#define ISRM_ALL                    (ISR_PCM_IRQ7 | ISR_PCM_IRQ6 | ISR_PCM_IRQ5 | ISR_PCM_IRQ4 |   \
                                     ISR_PCM_IRQ3 | ISR_PCM_IRQ2 | ISR_PCM_IRQ1 | ISR_PCM_IRQ0 |   \
...
#define spm_is_wakesrc_invalid(wakesrc)     (!!((u32)(wakesrc) & 0xc0003801))
...
{
    u32 phys = virt_to_phys(base);
    BUG_ON(phys & 0x00000003);  /* check 4-byte alignment */
    return phys;
}
