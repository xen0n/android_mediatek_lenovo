...
void mt_fixup(struct tag *tags, char **cmdline, struct meminfo *mi)
{
    ...
    if (mdesc)
    {
        ...
        {
            case 0xF:
                strcpy((void *)mdesc->name, "MT8389Q");
                break;
            case 0xC:
                strcpy((void *)mdesc->name, "MT8389S");
                break;
            case 0x0:
                strcpy((void *)mdesc->name, (i & (1 << 22)) ? "MT8151" : "MT8392");
        }
    }
#endif
...
//Lenovo-sw caoyi1 2014-03-25 hall add start
/*=======================================================================*/
/* hall sensor support */
/*=======================================================================*/
...
#endif
//Lenovo-sw caoyi1 2014-03-25 hall add end
...
extern void eemcs_memory_reserve(void);
