    0x100062c4, 0xc24030a0, 0x17c07c1f, 0x89400005, 0xffffffdf, 0xe8208000,
    0x10006f14, 0x00000000, 0xe8208000, 0x10006b44, 0x00000000, 0xe8208000,
    0x100063e0, 0x00000020, 0x81031401, 0xd8202bc4, 0x17c07c1f, 0x8108b001,
    0xb1003081, 0xd8202bc4, 0x17c07c1f, 0x1a40001f, 0x100062a8, 0x1a80001f,
    0x100062c8, 0xc24030a0, 0x17c07c1f, 0x89400005, 0xffffffbf, 0xe8208000,
    0x10006f18, 0x00000000, 0xe8208000, 0x10006b48, 0x00000000, 0xe8208000,
    0x100063e0, 0x00000040, 0x81039401, 0xd8202ec4, 0x17c07c1f, 0x810bb001,
    0xb1003081, 0xd8202ec4, 0x17c07c1f, 0x1a40001f, 0x100062ac, 0x1a80001f,
    0x100062cc, 0xc24030a0, 0x17c07c1f, 0x89400005, 0xffffff7f, 0xe8208000,
    0x10006f1c, 0x00000000, 0xe8208000, 0x10006b4c, 0x00000000, 0xe8208000,
    0x100063e0, 0x00000080, 0xd0000120, 0x17c07c1f, 0xd0000120, 0x17c07c1f,
    ...
    0xe2e00032, 0xf0000000, 0x17c07c1f, 0x80cab001, 0x808cb401, 0x80800c02,
    0xd82035c2, 0x17c07c1f, 0x1890001f, 0x10006014, 0x18c0001f, 0x10006014,
    0xa0978402, 0xe0c00002, 0x1b80001f, 0x10001000, 0xf0000000, 0x17c07c1f
...
static void spm_mcdi_init_wfi_sel(void)
{
    /*Init WFI SEL*/
...
static void spm_mcdi_init_cpu_wake_up_event(void)
{
    /* init r6 for init CPU_WAKEUP_EVENT,  R6 initial value should be 0x0*/
...
static void spm_mcdi_cpu_wake_up_event(bool wake_up_event, bool disable_dormant_power)
{
    ...
    {
        printk("spm_mcdi_cpu_wake_up_event: SPM_SLEEP_CPU_WAKEUP_EVENT:%x, SPM_CLK_CON %x",spm_read(SPM_SLEEP_CPU_WAKEUP_EVENT),spm_read(SPM_CLK_CON));
        return;
    }
...
wake_reason_t spm_go_to_mcdi(bool cpu_pdn)
{
    ...
    spm_mcdi_init_wfi_sel();
    
    spm_mcdi_init_cpu_wake_up_event();
...
u32 spm_leave_MCDI(void)
{
...
#if 1
    while(1)//don't use sleep command(wfi/wfe)
    {
        if(g_is_mcdi_wfi==0)
            break;
        if(spm_counter >= 100000)
        {
            printk("spm_leave_MCDI: g_is_mcdi_wfi:%x\n",g_is_mcdi_wfi);
            spm_counter=0;
        }
        spm_counter++;
    }
    ...
    while((spm_read(SPM_PCM_REG11_DATA))!=0x55AA55AA)//or R5=0xAA55AA55
    {
        if(spm_counter >= 100000)
        {
            printk("Polling MCDI return: SPM_PCM_REG11_DATA:0x%x\n",spm_read(SPM_PCM_REG11_DATA));
            printk("SPM_PCM_REG15_DATA:0x%x\n",spm_read(SPM_PCM_REG15_DATA));
            printk("SPM_PCM_REG6_DATA:0x%x\n",spm_read(SPM_PCM_REG6_DATA));
            printk("SPM_PCM_REG5_DATA:0x%x\n",spm_read(SPM_PCM_REG5_DATA));
            printk("SPM_APMCU_PWRCTL:0x%x\n",spm_read(SPM_APMCU_PWRCTL));
            printk("SPM_CLK_CON:0x%x\n",spm_read(SPM_CLK_CON));
            printk("SPM_SLEEP_CPU_WAKEUP_EVENT:0x%x\n",spm_read(SPM_SLEEP_CPU_WAKEUP_EVENT));
    ...
    spm_write(SPM_SLEEP_ISR_MASK, spm_read(SPM_SLEEP_ISR_MASK) | ISRM_ALL_EXC_TWAM);
    spm_write(SPM_SLEEP_ISR_STATUS, ISRC_ALL_EXC_TWAM);
    spm_write(SPM_PCM_SW_INT_CLEAR, PCM_SW_INT0|PCM_SW_INT1|PCM_SW_INT2|PCM_SW_INT3|PCM_SW_INT4|PCM_SW_INT5|PCM_SW_INT6|PCM_SW_INT7);
...
{
    bool ret = 1;
    if((SPM_MCDI_isKICK==0)||((spm_read(SPM_SLEEP_CPU_WAKEUP_EVENT)&0x1)==1)||((spm_read(SPM_APMCU_PWRCTL)&0x1)==1))
        ret = 0;
    return ret;
}

static bool spm_is_cpu_irq_occur(int core_id)
{
	bool ret = 1;

	if(core_id<=3)
	{
		if(spm_read(SPM_PCM_REG12_DATA)&(1<<(26+core_id))==0)
			ret = 0;
	}
	else
	{		
		...
		{
			case 4:
				if(spm_read(SPM_PCM_REG12_DATA)&(1<<7)==0)
					ret = 0;
				break;
			case 5:
				if(spm_read(SPM_PCM_REG12_DATA)&(1<<15)==0)
					ret = 0;				
				break;
			case 6:
				if(spm_read(SPM_PCM_REG12_DATA)&(1<<17)==0)
					ret = 0;				
				break;
			case 7:
				if(spm_read(SPM_PCM_REG12_DATA)&(1<<23)==0)
					ret = 0;				
				break;
...
{   
    ...
    {
        spin_unlock_irqrestore(&spm_lock, flags);
        //printk("SPM_SLEEP_CPU_WAKEUP_EVENT:%x, SPM_APMCU_PWRCTL %x",spm_read(SPM_SLEEP_CPU_WAKEUP_EVENT),spm_read(SPM_APMCU_PWRCTL));
        return ret;    
    }
    //printk("spm_mcdi_wfi\n");
    ...
    //if((core_id<=3)&&((spm_read(SPM_PCM_REG12_DATA)&(1<<(26+core_id))==0)))
    if(spm_is_cpu_irq_occur(core_id)==0)
    {
        ...
        if (!cpu_power_down(DORMANT_MODE,1)) 
        {
            ...
            //if(spm_read(SPM_PCM_REG12_DATA)&(1<<(26+core_id)))
            if(spm_is_cpu_irq_occur(core_id)==1)
            {
