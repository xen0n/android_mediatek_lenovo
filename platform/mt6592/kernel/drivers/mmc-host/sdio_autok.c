...
/*************************************************************************
* FUNCTION
*  autok_get_current_vcore
*
* DESCRIPTION
*  This function for auto-K, get current vcore value
*
* PARAMETERS
*
* RETURN VALUES
*    current vcore
*************************************************************************/ 
unsigned int autok_get_current_vcore(void)
{
    unsigned int vcore_uv_offset = 0;
    unsigned int vcore_uv = 0;
    vcore_uv_offset = autok_get_current_vcore_offset();
    vcore_uv = mt65x2_vcore_tbl[vcore_uv_offset];
