 ...
 * up level to msdc top. msdc top impliment by GPIO, so need sync with the GPIO designer(MingTe MT6592) 
 * for detail */
...
#define MSDC1_GPIO_DAT_PUPD_BASE              (GPIO_BASE + 0xC70)
#define MSDC1_GPIO_PAD_BASE                   (GPIO_BASE + 0xC80)

#define MSDC2_GPIO_CLK_BASE                   (GPIO_BASE + 0xC90)
#define MSDC2_GPIO_CMD_BASE                   (GPIO_BASE + 0xCA0)
#define MSDC2_GPIO_DAT_BASE                   (GPIO_BASE + 0xCB0)
#define MSDC2_GPIO_DAT_PUPD_BASE              (GPIO_BASE + 0xCC0)
#define MSDC2_GPIO_PAD_BASE                   (GPIO_BASE + 0xCD0)

#define MSDC3_GPIO_CLK_BASE                   (GPIO_BASE + 0xCE0)
#define MSDC3_GPIO_CMD_BASE                   (GPIO_BASE + 0xCF0)
#define MSDC3_GPIO_DAT_BASE                   (GPIO_BASE + 0xD00)
#define MSDC3_GPIO_DAT_PUPD_BASE              (GPIO_BASE + 0xD10)
#define MSDC3_GPIO_PAD_BASE                   (GPIO_BASE + 0xD20)

#define GPIO_PAD_TDSEL_MASK                   (0xFUL  <<  0) 
#define GPIO_PAD_RDSEL_MASK                   (0x3FUL <<  4)
#define GPIO_PAD_TUNE_MASK                    (0xFUL  << 10)   //not use in 92

#define GPIO_R0_MASK                          (0x1UL  <<  0)
#define GPIO_R1_MASK                          (0x1UL  <<  1)
#define GPIO_PUPD_MASK                        (0x1UL  <<  2)

#define GPIO_DAT0_R0_MASK                     (0x1UL  <<  0)
#define GPIO_DAT0_R1_MASK                     (0x1UL  <<  1)
#define GPIO_DAT0_PUPD_MASK                   (0x1UL  <<  2)

#define GPIO_DAT1_R0_MASK                     (0x1UL  <<  4)
#define GPIO_DAT1_R1_MASK                     (0x1UL  <<  5)
#define GPIO_DAT1_PUPD_MASK                   (0x1UL  <<  6)

#define GPIO_DAT2_R0_MASK                     (0x1UL  <<  8)
#define GPIO_DAT2_R1_MASK                     (0x1UL  <<  9)
#define GPIO_DAT2_PUPD_MASK                   (0x1UL  <<  10)

#define GPIO_DAT3_R0_MASK                     (0x1UL  <<  12)
#define GPIO_DAT3_R1_MASK                     (0x1UL  <<  13)
#define GPIO_DAT3_PUPD_MASK                   (0x1UL  <<  14)

#define GPIO_MSDC_E2_MASK                     (0x1UL  <<  8)
#define GPIO_MSDC_E4_MASK                     (0x1UL  <<  9)
#define GPIO_MSDC_E8_MASK                     (0x1UL  << 10)
...
#define GPIO_MSDC_DRVN                        (GPIO_MSDC_E2_MASK | GPIO_MSDC_E4_MASK | GPIO_MSDC_E8_MASK)

/* add pull down/up mode define */
#define MSDC_PULL_NONE      (2)
#define MSDC_PU_10K         (1)
#define MSDC_PU_50K         (3)
#define MSDC_PU_8K          (4)
#define MSDC_PD_10K         (0)
#define MSDC_PD_50K         (5)
#define MSDC_PD_8K          (6)        
