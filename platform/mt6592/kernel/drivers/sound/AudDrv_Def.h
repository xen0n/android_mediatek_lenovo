...
*/
#ifdef DEBUG_TOOL_AUDDRV_DRAW
#define PRINTK_DEBUGTOOL_DRAW(format, args...) printk(format, ##args )
#else
#define PRINTK_DEBUGTOOL_DRAW(format, args...)
#endif

#ifdef DEBUG_AUDDRV
#define PRINTK_AUDDRV(format, args...) printk(format, ##args )
#define PRINTK_DEBUG_MODE(format, args...) if(isDebugMode){ printk(format, ##args ); }
#else
#define PRINTK_AUDDRV(format, args...)
#endif
