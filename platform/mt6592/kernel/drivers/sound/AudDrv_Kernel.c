...
#if defined(MHL_HDMI_SUPPORT)
#if defined(MHL_PHONE_GPIO_REUSAGE)
                mt_set_gpio_mode(GPIO_PCM_DAIPCMOUT_PIN, GPIO_MODE_02);
#endif                
#endif
...
#if defined(MHL_HDMI_SUPPORT)
#if defined(MHL_PHONE_GPIO_REUSAGE)
                if(mt_get_gpio_mode(GPIO_PCM_DAIPCMOUT_PIN)== GPIO_MODE_02)
                {
