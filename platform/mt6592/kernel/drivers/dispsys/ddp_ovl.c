...
extern unsigned int gOvlRdmaFifoCtrl;
int OVLStart() {
    
    DISP_REG_SET(DISP_REG_OVL_INTEN, 0x0f);
    DISP_REG_SET(DISP_REG_OVL_EN, 0x01);

    //DISP_REG_SET_FIELD(RDMA0_FIFO_CTRL_FLD_RDMA0_FIFO_THRD, DISP_REG_OVL_RDMA0_FIFO_CTRL, 32);
    //DISP_REG_SET_FIELD(RDMA0_FIFO_CTRL_FLD_RDMA0_FIFO_THRD, DISP_REG_OVL_RDMA1_FIFO_CTRL, 32);
    //DISP_REG_SET_FIELD(RDMA0_FIFO_CTRL_FLD_RDMA0_FIFO_THRD, DISP_REG_OVL_RDMA2_FIFO_CTRL, 32);
    //DISP_REG_SET_FIELD(RDMA0_FIFO_CTRL_FLD_RDMA0_FIFO_THRD, DISP_REG_OVL_RDMA3_FIFO_CTRL, 32);
   
    DISP_REG_SET(DISP_REG_OVL_RDMA0_FIFO_CTRL, gOvlRdmaFifoCtrl);
    DISP_REG_SET(DISP_REG_OVL_RDMA1_FIFO_CTRL, gOvlRdmaFifoCtrl);
    DISP_REG_SET(DISP_REG_OVL_RDMA2_FIFO_CTRL, gOvlRdmaFifoCtrl);
    DISP_REG_SET(DISP_REG_OVL_RDMA3_FIFO_CTRL, gOvlRdmaFifoCtrl);
...
#if 0
    start = address;
    end = start + bpp * width - 1;  // Last byte of last pixel
