...
{
	/*to see current pmic is MT6322 or MT6323*/
	INT32 pmic_chipid = 0;
	UINT32 bit_val = 0;
	
#if CONSYS_PMIC_CTRL_ENABLE
	pmic_read_interface(0x63C,&bit_val,0x1,14); //get [0x63][14] to see pmic chipid
...
{
	/* to write 1 or 0 to 0x0414[12] according to A die chip and PMIC chip */
