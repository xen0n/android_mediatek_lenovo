...
//lenovo-sw 20140416 add:support  "Multi Gamma" function begin
#ifdef LENOVO_LCM_MULTI_GAMMA_PQ
static bool config_gamma_enable = false;
void (*callback_ddp)(void *param);
void *param_ddp;
#endif
//lenovo-sw 20140416 add:support  "Multi Gamma" function end
typedef struct
{
	DSI_REGS regBackup;
...
//lenovo-sw yexm1 20140416 add:support  "Multi Gamma" function	begin
#ifdef LENOVO_LCM_MULTI_GAMMA_PQ
...
#endif
//lenovo-sw yexm1 20140416 add:support  "Multi Gamma" function	end
