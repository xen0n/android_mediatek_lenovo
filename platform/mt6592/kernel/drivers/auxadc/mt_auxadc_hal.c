...
static void mt_auxadc_cal_prepare(void)
{
	...
	if(mt_auxadc_bgr&0x0F000000)
	{
		AUXADC_SET_BITS(((mt_auxadc_bgr&0x0F000000)>>16),AUXADC_TS_CON0);
	}
	printk("[adc_cali]:mt_auxadc_cal_prepare, after cali, get AUXADC_TS_CON0 0x%04x \n",DRV_Reg32(AUXADC_TS_CON0));
...
{
	printk("AUXADC SUSPEND!\n");
}

void mt_auxadc_hal_resume(void)
{
	printk("AUXADC RESUME!\n");
	mt_auxadc_cal_prepare();
}
