...
/*For chip Bringup Start*/
/*
#ifdef MTK_BTIF_ENABLE_CLK_CTL
#undef MTK_BTIF_ENABLE_CLK_CTL
#endif
#define MTK_BTIF_ENABLE_CLK_CTL 0
*/
/*For chip Bringup End*/
