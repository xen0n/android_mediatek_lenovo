...
#define MTK_WDT_MODE_DUMMY		(0x10000000+0x0500)
#define MTK_WDT_RESTART_DUMMY	(0x10000000+0x0508)
#define MTK_WDT_DEGLITCH_EN     (0x10000000+0x0310)
...
/*MTK_WDT_NONRST_REG2*/
#define MTK_WDT_AUTO_RESTART_FLAG	(0x0002) /* Reserved */
...
#define MTK_WDT_MODE_DUMMY_RESTART (0x0010)	
...
#define MTK_WDT_STATUS_THERMAL_RST	(0x0001)
...
#define RE_BOOT_BY_THERMAL              (0x08)
