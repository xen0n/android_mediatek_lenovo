...
# Keep ROM size smaller than 0x0022_0000 - 0x0020_0100 =0x1FF00 (130816) Bytes
# start address is 0x0020_0100, GFH file is placed in the front of the start address, GFH size = 0x300 (768)
#  - Hash(32) - Signature(260) ) (292)
PL_MAX_ROM_SIZE=$(( 130816 ))
