...
public:
    ...
    /*******************************************************************************
       ...
       *
       ********************************************************************************/
    virtual int init(unsigned long sensorDev, int lowBatDuty);



    virtual int initTemp(unsigned long sensorDev, int lowBatDuty);
	...
	virtual int lowPowerDetectStart();
	virtual int lowPowerDetectEnd(int* isLowPower);

	virtual int lowPowerProtectStart();
	virtual int lowPowerProtectEnd();
