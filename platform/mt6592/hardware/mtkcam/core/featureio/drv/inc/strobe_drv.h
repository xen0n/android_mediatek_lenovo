...
public:
    ...
    /*******************************************************************************
       ...
       *
       ********************************************************************************/
    virtual int init(unsigned long sensorDev, int lowBatDuty=-1)= 0;

    virtual int initTemp(unsigned long sensorDev, int lowBatDuty=-1)= 0;
	...
	virtual int lowPowerDetectStart()=0;
	virtual int lowPowerDetectEnd(int* isLowPower)=0;

	virtual int lowPowerProtectStart()=0;
	virtual int lowPowerProtectEnd()=0;
