...
private:  // Accumulation Mode
    /**
     *  @brief update accumulated GMV for internal propose
     *  @details Since doEIS() will be trigger at the end of pass1, just call this function in doEIS() should be enought.
     */
    virtual MVOID   updateAccumulatedGMV();
    virtual MVOID   updateAccumulatedGMV1();
    virtual MVOID   updateAccumulatedGMV2();

    virtual MVOID   startLog();
    virtual MVOID   writeLog(char *string, MUINT32 length);
    virtual MVOID   stopLog();
...
private:
    ...
    // Accumulation Mode
    MBOOL mAccumulationModeOn;
    MUINT32 mConfidenceThreshold;
    MFLOAT mAccumulatedGMV_X;
    MFLOAT mAccumulatedGMV_Y;
    MINT32 mIIR_DS;
    // Accumulation Mode Log
    MUINT32 mLogOffset;
    char *mLogBuffer;
    MUINT32 mLogCount;
    MBOOL mLogOn;
