...
)
{
    ...
    OTEnvInfo.WorkingBufAddr = (MUINT32)working_buffer;
...
bool doYV12Buffer_DDP(MUINT8 *a_dstAddr, MUINT8 *a_srcAddr)
{
    ...
    if(g_Plane ==2)
    {
        ...
        FDstream.setSrcConfig(g_OTw, g_OTh, eYUV_420_2P_YVYU);
    }
    ...
    else if(g_Plane ==3)
    {
        ...
        FDstream.setSrcBuffer((void**)src_addr_list, src_size_list, g_Plane);
        FDstream.setSrcConfig(g_OTw, g_OTh, eYUV_420_3P_YVU);
    }
    ...
    FDstream.setDstConfig(g_Dst_width, g_Dst_height, eYUV_420_3P);
