...
class IspDrvImp : public IspDrv
{
    public:
        ...
        virtual MBOOL   ClockOverDriveEnable(MUINT32 EnableLevel);  //For ISP CLOCK Overdrive enable
...
class IspDrvVirImp : public IspDrv
{
    public:
        ...
        virtual MBOOL   ClockOverDriveEnable(MUINT32 EnableLevel){return MFALSE;}  //For ISP CLOCK Overdrive enable
