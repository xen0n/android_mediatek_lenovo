...
public:
    ...
    bool init(ACDK_SCENARIO_ID_ENUM scenarioId)
    {
        ...
        //getHwValidSize(eID_Pass1Out,mu4MemOutW, mu4MemOutH);
        //
...
initCfg()
{
    ...
    mPorts.pass1DispOut.crop.x = 0;
    mPorts.pass1DispOut.crop.y = 0;
    mPorts.pass1DispOut.crop.w = mPorts.pass1DispOut.u4Width;
    mPorts.pass1DispOut.crop.h = mPorts.pass1DispOut.u4Height;
