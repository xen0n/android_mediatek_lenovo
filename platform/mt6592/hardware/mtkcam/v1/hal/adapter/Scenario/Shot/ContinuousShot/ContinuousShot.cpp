...
{ 
...

    {
        ...
        mpMultiShot->enableNotifyMsg(NSCamShot::ECamShot_NOTIFY_MSG_EOF         |
                                     NSCamShot::ECamShot_NOTIFY_MSG_CSHOT_END   |
                                     NSCamShot::ECamShot_NOTIFY_MSG_FOCUS_VALUE);
        //                             NSCamShot::ECamShot_NOTIFY_MSG_ENCODE_DONE);
        //
        ...
        NSCamShot::SensorParam rSensorParam(
                                 static_cast<MUINT32>(MtkCamUtils::DevMetaInfo::queryHalSensorDev(getOpenId())), //Device ID 
...
ContinuousShot::handleNotifyCb(NSCamShot::CamShotNotifyInfo const msg)
{
    ...
    case NSCamShot::ECamShot_NOTIFY_MSG_FOCUS_VALUE:
        ...
        break;
    case NSCamShot::ECamShot_NOTIFY_MSG_ENCODE_DONE:
#if 0
        if(mbCbShutterMsg)
        {
            mpShotCallback->onCB_Shutter(false, mu4ShotConut);
...
handleJpegData(MUINT8* const puJpegBuf, MUINT32 const u4JpegSize, MUINT8* const puThumbBuf, MUINT32 const u4ThumbSize)
{
    ...
    if( mpuExifHeaderBuf == NULL )
    {
        mpuExifHeaderBuf = new MUINT8[128 * 1024];
    }
