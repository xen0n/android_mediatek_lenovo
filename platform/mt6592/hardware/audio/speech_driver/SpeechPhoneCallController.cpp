...
bool SpeechPhoneCallController::CheckSideToneFilterNeedOn(const audio_devices_t output_device) const
{
    ...
    return ((CheckTtyNeedOn() == false) &&
            //(mAudioVolumeInstance->GetSideToneGain(output_device) != 0) &&   // cannot apply side tone in current call
...
status_t SpeechPhoneCallController::OpenModemSpeechDigitalPart(const modem_index_t modem_index, const audio_devices_t output_device)
{
    ...
    if (bt_device_on) // DAIBT
    {
        if (modem_index == MODEM_1)
        {
            if (WCNChipController::GetInstance()->BTUseCVSDRemoval() != true)
            {
                ...
                master_2nd_i2s_out_attribute.mI2S_HD_EN = AudioDigtalI2S::LOW_JITTER_CLOCK;
#else
                master_2nd_i2s_out_attribute.mI2S_WLEN = AudioDigtalI2S::WLEN_16BITS;
                master_2nd_i2s_out_attribute.mI2S_HD_EN = AudioDigtalI2S::NORMAL_CLOCK;
#endif
    ...
    else // ADC/DAC I2S
    {
        ...
        if ( ((output_device & AUDIO_DEVICE_OUT_WIRED_HEADSET)||(output_device & AUDIO_DEVICE_OUT_WIRED_HEADPHONE)) && (output_device & AUDIO_DEVICE_OUT_SPEAKER) )
        {
            if (modem_index == MODEM_1)
            {
                // UL
                mAudioDigitalInstance->SetinputConnection(AudioDigitalType::Connection, AudioDigitalType::I03, AudioDigitalType::O17);
                // echo ref
                mAudioDigitalInstance->SetinputConnection(AudioDigitalType::Connection, AudioDigitalType::I01, AudioDigitalType::O16);
                mAudioDigitalInstance->SetinputConnection(AudioDigitalType::Connection, AudioDigitalType::I13, AudioDigitalType::O18);
                // DL
                mAudioDigitalInstance->SetinputConnection(AudioDigitalType::Connection, AudioDigitalType::I14, AudioDigitalType::O00);
                mAudioDigitalInstance->SetinputConnection(AudioDigitalType::Connection, AudioDigitalType::I14, AudioDigitalType::O01);
				mAudioDigitalInstance->SetinputConnection(AudioDigitalType::Connection, AudioDigitalType::I14, AudioDigitalType::O03);
                mAudioDigitalInstance->SetinputConnection(AudioDigitalType::Connection, AudioDigitalType::I14, AudioDigitalType::O04);
            }
            else
            {
                // UL
                mAudioDigitalInstance->SetinputConnection(AudioDigitalType::Connection, AudioDigitalType::I03, AudioDigitalType::O07);
                // echo ref
                mAudioDigitalInstance->SetinputConnection(AudioDigitalType::Connection, AudioDigitalType::I01, AudioDigitalType::O16);
                mAudioDigitalInstance->SetinputConnection(AudioDigitalType::Connection, AudioDigitalType::I13, AudioDigitalType::O08);
                // DL
                mAudioDigitalInstance->SetinputConnection(AudioDigitalType::Connection, AudioDigitalType::I09, AudioDigitalType::O00);
                mAudioDigitalInstance->SetinputConnection(AudioDigitalType::Connection, AudioDigitalType::I09, AudioDigitalType::O01);
				mAudioDigitalInstance->SetinputConnection(AudioDigitalType::Connection, AudioDigitalType::I09, AudioDigitalType::O03);
                mAudioDigitalInstance->SetinputConnection(AudioDigitalType::Connection, AudioDigitalType::I09, AudioDigitalType::O04);
            }
        }
		else if ((output_device & AUDIO_DEVICE_OUT_SPEAKER) && (CheckTtyNeedOn() == false))
        {
            if (modem_index == MODEM_1)
            {
                // UL
		...
		else if ((output_device & AUDIO_DEVICE_OUT_SPEAKER) && (CheckTtyNeedOn() == true))
        {
            if (modem_index == MODEM_1)
            {
                // UL
                mAudioDigitalInstance->SetinputConnection(AudioDigitalType::Connection, AudioDigitalType::I03, AudioDigitalType::O17);
                mAudioDigitalInstance->SetinputConnection(AudioDigitalType::Connection, AudioDigitalType::I04, AudioDigitalType::O18);
                // DL
                mAudioDigitalInstance->SetinputConnection(AudioDigitalType::Connection, AudioDigitalType::I14, AudioDigitalType::O00);
                mAudioDigitalInstance->SetinputConnection(AudioDigitalType::Connection, AudioDigitalType::I14, AudioDigitalType::O01);
            }
            else
            {
                // UL
                mAudioDigitalInstance->SetinputConnection(AudioDigitalType::Connection, AudioDigitalType::I03, AudioDigitalType::O07);
                mAudioDigitalInstance->SetinputConnection(AudioDigitalType::Connection, AudioDigitalType::I04, AudioDigitalType::O08);
                // DL
                mAudioDigitalInstance->SetinputConnection(AudioDigitalType::Connection, AudioDigitalType::I09, AudioDigitalType::O00);
                mAudioDigitalInstance->SetinputConnection(AudioDigitalType::Connection, AudioDigitalType::I09, AudioDigitalType::O01);
            }
        ...
        if (((output_device & AUDIO_DEVICE_OUT_WIRED_HEADSET)||(output_device & AUDIO_DEVICE_OUT_WIRED_HEADPHONE)) && (output_device & AUDIO_DEVICE_OUT_SPEAKER))
        {
        	mAudioDigitalInstance->SetI2SSoftReset(true);       // set 4-wire I2S mode
            SetModemSpeechADC2ndI2sInAttribute(sample_rate);
            SetModemSpeechDAC2ndI2sOutAttribute(sample_rate);
        ...
        {
            // SET HW_GAIN2
            AudioMEMIFAttribute::SAMPLINGRATE mem_sample_rate = (sample_rate == 8000) ? AudioMEMIFAttribute::AFE_8000HZ : AudioMEMIFAttribute::AFE_16000HZ;
            mAudioDigitalInstance->SetHwDigitalGainMode(AudioDigitalType::HW_DIGITAL_GAIN2, mem_sample_rate, 0xC8);
            mAudioDigitalInstance->SetHwDigitalCurrentGain(0x80000, AudioDigitalType::HW_DIGITAL_GAIN2);
            mAudioDigitalInstance->SetHwDigitalGain(0x80000, AudioDigitalType::HW_DIGITAL_GAIN2);
            mAudioDigitalInstance->SetHwDigitalGainEnableByPassRampUp(AudioDigitalType::HW_DIGITAL_GAIN2, true);

            // Set I2S 4-wire mode
            mAudioDigitalInstance->Set2ndI2SInEnable(true);
            mAudioDigitalInstance->Set2ndI2SOutEnable(true);
			mAudioDigitalInstance->SetI2SDacEnable(true);
            mAudioDigitalInstance->SetI2SSoftReset(false);       // finish 4-wire I2S mode
            ALOGD("NXP speaker set i2s & hw gain2: HS/HP + speaker");
        }
		else if ((output_device & AUDIO_DEVICE_OUT_SPEAKER) && (CheckTtyNeedOn() == false))
        {
            // SET HW_GAIN2
            ...
            mAudioDigitalInstance->Set2ndI2SOutEnable(true);
            mAudioDigitalInstance->SetI2SSoftReset(false);       // finish 4-wire I2S mode
            ALOGD("NXP speaker set i2s & hw gain2: speaker");
        }
		else if ((output_device & AUDIO_DEVICE_OUT_SPEAKER) && (CheckTtyNeedOn() == true))
        {
            // Set I2S 4-wire mode
            mAudioDigitalInstance->Set2ndI2SOutEnable(true);
            mAudioDigitalInstance->SetI2SSoftReset(false);       // finish 4-wire I2S mode
            ALOGD("NXP speaker set i2s: speaker + TTY");
        }
        else
        {
            mAudioDigitalInstance->SetI2SDacEnable(true);
...
status_t SpeechPhoneCallController::CloseModemSpeechDigitalPart(const modem_index_t modem_index, const audio_devices_t output_device)
{
    ...
    else
    {
        ...
        if (((output_device & AUDIO_DEVICE_OUT_WIRED_HEADSET)||(output_device & AUDIO_DEVICE_OUT_WIRED_HEADPHONE)) && (output_device & AUDIO_DEVICE_OUT_SPEAKER))
        {
            ...
            {
                // UL
                mAudioDigitalInstance->SetinputConnection(AudioDigitalType::DisConnect, AudioDigitalType::I03, AudioDigitalType::O17);
                // echo ref
                mAudioDigitalInstance->SetinputConnection(AudioDigitalType::DisConnect, AudioDigitalType::I01, AudioDigitalType::O16);
                mAudioDigitalInstance->SetinputConnection(AudioDigitalType::DisConnect, AudioDigitalType::I13, AudioDigitalType::O18);
                // DL
                mAudioDigitalInstance->SetinputConnection(AudioDigitalType::DisConnect, AudioDigitalType::I14, AudioDigitalType::O00);
                mAudioDigitalInstance->SetinputConnection(AudioDigitalType::DisConnect, AudioDigitalType::I14, AudioDigitalType::O01);
				mAudioDigitalInstance->SetinputConnection(AudioDigitalType::DisConnect, AudioDigitalType::I14, AudioDigitalType::O03);
                mAudioDigitalInstance->SetinputConnection(AudioDigitalType::DisConnect, AudioDigitalType::I14, AudioDigitalType::O04);
            }
            else
            {
                // UL
                mAudioDigitalInstance->SetinputConnection(AudioDigitalType::DisConnect, AudioDigitalType::I03, AudioDigitalType::O07);
                // echo ref
                mAudioDigitalInstance->SetinputConnection(AudioDigitalType::DisConnect, AudioDigitalType::I01, AudioDigitalType::O16);
                mAudioDigitalInstance->SetinputConnection(AudioDigitalType::DisConnect, AudioDigitalType::I13, AudioDigitalType::O18);
                // DL
                mAudioDigitalInstance->SetinputConnection(AudioDigitalType::DisConnect, AudioDigitalType::I09, AudioDigitalType::O00);
                mAudioDigitalInstance->SetinputConnection(AudioDigitalType::DisConnect, AudioDigitalType::I09, AudioDigitalType::O01);
				mAudioDigitalInstance->SetinputConnection(AudioDigitalType::DisConnect, AudioDigitalType::I09, AudioDigitalType::O03);
                mAudioDigitalInstance->SetinputConnection(AudioDigitalType::DisConnect, AudioDigitalType::I09, AudioDigitalType::O04);
            }
        }
		else if ((output_device & AUDIO_DEVICE_OUT_SPEAKER) && (CheckTtyNeedOn() == false))
        {
            ...
            else
            {
                ...
                // echo ref
                mAudioDigitalInstance->SetinputConnection(AudioDigitalType::DisConnect, AudioDigitalType::I01, AudioDigitalType::O16);
                mAudioDigitalInstance->SetinputConnection(AudioDigitalType::DisConnect, AudioDigitalType::I13, AudioDigitalType::O08);
                // DL
                mAudioDigitalInstance->SetinputConnection(AudioDigitalType::DisConnect, AudioDigitalType::I09, AudioDigitalType::O00);
                mAudioDigitalInstance->SetinputConnection(AudioDigitalType::DisConnect, AudioDigitalType::I09, AudioDigitalType::O01);
            }
		...
		else if ((output_device & AUDIO_DEVICE_OUT_SPEAKER) && (CheckTtyNeedOn() == true))
        {
            ...
            if (modem_index == MODEM_1)
            {
                // UL
                mAudioDigitalInstance->SetinputConnection(AudioDigitalType::DisConnect, AudioDigitalType::I03, AudioDigitalType::O17);
                mAudioDigitalInstance->SetinputConnection(AudioDigitalType::DisConnect, AudioDigitalType::I04, AudioDigitalType::O18);
                // DL
                mAudioDigitalInstance->SetinputConnection(AudioDigitalType::DisConnect, AudioDigitalType::I14, AudioDigitalType::O00);
                mAudioDigitalInstance->SetinputConnection(AudioDigitalType::DisConnect, AudioDigitalType::I14, AudioDigitalType::O01);
            }
            else
            {
                // UL
                mAudioDigitalInstance->SetinputConnection(AudioDigitalType::DisConnect, AudioDigitalType::I03, AudioDigitalType::O07);
                mAudioDigitalInstance->SetinputConnection(AudioDigitalType::DisConnect, AudioDigitalType::I04, AudioDigitalType::O08);
                // DL
                mAudioDigitalInstance->SetinputConnection(AudioDigitalType::DisConnect, AudioDigitalType::I09, AudioDigitalType::O00);
                mAudioDigitalInstance->SetinputConnection(AudioDigitalType::DisConnect, AudioDigitalType::I09, AudioDigitalType::O01);
            }
        ...
        if (((output_device & AUDIO_DEVICE_OUT_WIRED_HEADSET)||(output_device & AUDIO_DEVICE_OUT_WIRED_HEADPHONE)) && (output_device & AUDIO_DEVICE_OUT_SPEAKER))
        {
			...
			mAudioDigitalInstance->SetI2SDacEnable(false);
			mAudioDigitalInstance->SetI2SAdcEnable(false);
            SetModemSpeechInterConnection(AudioDigitalType::I2S_OUT_2, modem_index, AudioDigitalType::DisConnect);
			SetModemSpeechInterConnection(AudioDigitalType::I2S_OUT_DAC, modem_index, AudioDigitalType::DisConnect);
            SetModemSpeechInterConnection(AudioDigitalType::I2S_IN_ADC, modem_index, AudioDigitalType::DisConnect);
        }
		else if ((output_device & AUDIO_DEVICE_OUT_SPEAKER))
...
status_t SpeechPhoneCallController::SetModemSpeechInterConnection(AudioDigitalType::Digital_Block block, modem_index_t modem_index, AudioDigitalType::InterConnectionState Connection)
{
    ...
    switch (block)
    {
        ...
        case AudioDigitalType::I2S_OUT_DAC:
            ...
            break;
#if (defined(NXP_SMARTPA_SUPPORT) || defined(USING_TFA9887_EXTAMP))
		case AudioDigitalType::I2S_OUT_2:
            mAudioDigitalInstance->SetinputConnection(Connection, modem_pcm_rx         , AudioDigitalType::O00); // MODEM_PCM_RX   -> 2nd_I2S_OUT_L
            mAudioDigitalInstance->SetinputConnection(Connection, modem_pcm_rx         , AudioDigitalType::O01); // MODEM_PCM_RX   -> 2nd_I2S_OUT_R
            break;
#endif
        default:
...
status_t SpeechPhoneCallController::SetModemSpeechDACI2sOutAttribute(int sample_rate)
{
    ...
    dac_i2s_out_attribute.mI2S_HD_EN = AudioDigtalI2S::NORMAL_CLOCK;
#endif
    mAudioDigitalInstance->SetI2SDacOut(&dac_i2s_out_attribute);
    return NO_ERROR;
}

status_t SpeechPhoneCallController::SetModemSpeechDAC2ndI2sOutAttribute(int sample_rate)
{
    AudioDigtalI2S dac_i2s_out_attribute;
    memset((void *)&dac_i2s_out_attribute, 0, sizeof(dac_i2s_out_attribute));
    ...
    dac_i2s_out_attribute.mI2S_HD_EN = AudioDigtalI2S::NORMAL_CLOCK;
#endif
    mAudioDigitalInstance->Set2ndI2SOut(&dac_i2s_out_attribute);
    return NO_ERROR;
}

status_t SpeechPhoneCallController::SetModemSpeechADC2ndI2sInAttribute(int sample_rate)
{
...
#if defined(I2S_LOW_JITTER_MODE)
    adc_i2s_in_attribute.mI2S_WLEN = AudioDigtalI2S::WLEN_32BITS;
    adc_i2s_in_attribute.mI2S_HD_EN = AudioDigtalI2S::LOW_JITTER_CLOCK;
#else
    adc_i2s_in_attribute.mI2S_WLEN = AudioDigtalI2S::WLEN_16BITS;
    adc_i2s_in_attribute.mI2S_HD_EN = AudioDigtalI2S::NORMAL_CLOCK;
#endif

#if defined(NXP_SMARTPA_SUPPORT)
    adc_i2s_in_attribute.mI2S_IN_PAD_SEL = AudioDigtalI2S::I2S_IN_FROM_IO_MUX;  // for nxp echo signal data in while phone call
#endif
    adc_i2s_in_attribute.mI2S_SAMPLERATE = sample_rate;
    adc_i2s_in_attribute.mI2S_EN = false;
    mAudioDigitalInstance->Set2ndI2SIn(&adc_i2s_in_attribute);
    return NO_ERROR;
}

status_t SpeechPhoneCallController::SetModemSpeechDACI2sOutAttributeByDevice(int sample_rate, const audio_devices_t output_device)
{
    AudioDigtalI2S dac_i2s_out_attribute;
    memset((void *)&dac_i2s_out_attribute, 0, sizeof(dac_i2s_out_attribute));
...
status_t SpeechPhoneCallController::SetTtyCtmMode(const tty_mode_t tty_mode, const audio_mode_t audio_mode)
{
    ...
    if (mTty_Ctm != tty_mode)
    {
            ...
            pSpeechDriver->GetApSideModemStatus(SPEECH_STATUS_MASK) == true)
        {
            ...
            CloseModemSpeechDigitalPart(modem_index, (audio_devices_t)mAudioResourceManager->getDlOutputDevice()); 
            SetTtyInOutDevice(GetRoutingForTty(), mTty_Ctm, audio_mode);
            OpenModemSpeechDigitalPart(modem_index, (audio_devices_t)mAudioResourceManager->getDlOutputDevice()); 
