...
status_t AudioLoopbackController::OpenAudioLoopbackControlFlow(const audio_devices_t input_device, const audio_devices_t output_device, uint32 ul_samplerate, uint32 dl_samplerate)
{
    ...
    {
        if (mAudioDigitalInstance->DlPolicyByDevice(output_device) == AudioDigitalType::I2S_OUT_DAC)
        {
        ...
        {
            mAudioDigitalInstance->SetinputConnection(AudioDigitalType::Connection, AudioDigitalType::I03, AudioDigitalType::O00);
            mAudioDigitalInstance->SetinputConnection(AudioDigitalType::Connection, AudioDigitalType::I03, AudioDigitalType::O01);            
            SetADCI2sInAttribute(ul_samplerate);
            mAudioDigitalInstance->Set2ndI2SOutAttribute(dl_samplerate);           
            mAudioDigitalInstance->SetI2SAdcEnable(true);
...
status_t AudioLoopbackController::CloseAudioLoopbackControlFlow()
{
    ...
    else
    {
        ...
        else
        {
            ...
            mAudioDigitalInstance->SetI2SAdcEnable(false);
            mAudioDigitalInstance->SetinputConnection(AudioDigitalType::DisConnect, AudioDigitalType::I03, AudioDigitalType::O00); // ADC_I2S_IN_L -> DAC_I2S_OUT_L
            mAudioDigitalInstance->SetinputConnection(AudioDigitalType::DisConnect, AudioDigitalType::I03, AudioDigitalType::O01); // ADC_I2S_IN_R -> DAC_I2S_OUT_R
