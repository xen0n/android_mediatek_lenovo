...
#if 0 //HP switch
uint32_t AudioMachineDevice::GetHeadPhoneGainReg(AudioAnalogType::VOLUME_TYPE volume_Type)
{
    uint32 regvalue = 0, volume = 0;
...
status_t AudioMachineDevice::AnalogOpen(AudioAnalogType::DEVICE_TYPE DeviceType)
{
    ...
    switch (DeviceType)
    {
        ...
        case AudioAnalogType::DEVICE_OUT_HEADSETL:
            ...
            mAudioAnalogReg->SetAnalogReg(AUDTOP_CON4, 0x007F, 0xffff); // mute L/R
#else
