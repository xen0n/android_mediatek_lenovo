...
class SpeechPhoneCallController
{
	...
	virtual status_t        SetModemSpeechDAC2ndI2sOutAttribute(int sample_rate);
        virtual status_t        SetModemSpeechDACI2sOutAttributeByDevice(int sample_rate, const audio_devices_t output_device);
        virtual status_t        SetModemSpeechADCI2sInAttribute(int sample_rate);
        virtual status_t        SetModemSpeechADC2ndI2sInAttribute(int sample_rate);
