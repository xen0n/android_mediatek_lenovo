...
class AudioMTKStreamOut : public android_audio_legacy::AudioStreamOut
{
    ...
    private:
        ...
        void setLowLatencyMode(bool mode,bool bforce = false);
        void setKernelDebugMode(bool mode);
...
/*lenovo-sw fuxm1 add new feature for leaveway mode 20140522*/
        bool isLeavewayMode = false;

        struct timespec mNewtime, mOldtime; //for calculate latency
        double time[3]; //0=>framework delay, 1=>Hal delay, 2=>kernel delay
