...
#define INT_POL_CTL0        (MCUSYS_CFGREG_BASE + 0x220)
/**************************************************
 *                   F002 0000                    *
 **************************************************/
 ...
 *                   F008 0000                    *
 **************************************************/
#define CAM_BASE			(IO_PHYS + 0x05004000)
/**************************************************
 *                   F009 0000                    *
 **************************************************/
 ...
 *                   F00A 0000                    *
 **************************************************/
#define FAKE_ENG2_BASE		         (IO_PHYS + 0x05002000)
...
/**************************************************SE                (IO_PHYS + 0x0100D000) // 2011-02-16 Koshi: Modified for MT6575 NAND driver
 57 #define NFIECC_BASE             (IO_PHYS + 0x0100E000) // 2011-02-16 Koshi: Modified for MT6575 NAND driver

 *                    0000                    *
 **************************************************/
#define LCD_BASE           	(IO_PHYS + 0x0400C000) //2011-05-10, zaikuo for mt6575
...
#define DISP_UFOE_BASE      (IO_PHYS + 0x04013000)
...
/*lenovo-sw chuyq 2013.3.18 remove begin*/
#if 0
#define HAVE_LK_TEXT_MENU
#endif
/*lenovo-sw chuyq 2013.3.18 remove end*/
