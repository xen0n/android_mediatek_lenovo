...
extern void tps6128x_hw_init(void);
#endif
//==============================================================================
// PMIC access API
//==============================================================================
...
/*Lenovo-sw caoyi1 modify for vibrate 2014-05-05 start*/
    int time_vibrate_begin,time_vibrate_end;

    time_vibrate_begin= gpt4_tick2time_ms(gpt4_get_current_tick());
    //printf("vibrate begin  at  %d ms \n",time_vibrate_begin);
    ...
    time_vibrate_end= gpt4_tick2time_ms(gpt4_get_current_tick());
    //printf("vibrate end  at  %d ms \n",time_vibrate_end);
/*Lenovo-sw caoyi1 modify for vibrate 2014-05-05 end*/
