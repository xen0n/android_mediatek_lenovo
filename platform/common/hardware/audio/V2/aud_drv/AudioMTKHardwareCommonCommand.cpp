...
// for Leaveway Mode
/*lenovo-sw fuxm1 add for new feature 20140522*/
static String8 keySET_LEAVEAWAY_MODE_ENABLE = String8("SET_LEAVEAWAY_MODE_ENABLE");
...
/*lenovo-sw fuxm1 add for new feature 20140522*/
        if (param.getInt(keySET_LEAVEAWAY_MODE_ENABLE, value) == NO_ERROR)
        {
            ALOGD("keySET_LEAVEAWAY_MODE_ENABLE=%d", value);
            mAudioMTKStreamManager->setParametersToStreamOut(keyValuePairs);
            param.remove(keySET_LEAVEAWAY_MODE_ENABLE);
            break;
        }
