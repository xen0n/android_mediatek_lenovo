...
typedef enum __VENC_DRV_SCENARIO_T
{
    ...
    VENC_DRV_SCENARIO_LIVEPHOTO_CAPTURE = 2,        ///< LivePhoto recording
    VENC_DRV_SCENARIO_LIVEPHOTO_EFFECT  = 4,        ///< LivePhoto effect transcoding
} VENC_DRV_SCENARIO_T;
...
typedef struct __VENC_DRV_PARAM_BS_BUF_T
{
    ...
    VAL_UINT32_T            u4BSStartVA;    ///< [IN] Bitstream fill start address
    VAL_UINT32_T            u4BSSize;       ///< [IN] Bitstream size (filled bitstream in bytes)    
