...
#define IMX135_TEST_PATTERN_CHECKSUM (0x2a0a5eb0)
...
{	
    ...
    IMX135MIPI_write_cmos_sensor(0x030D,0xC2);
    ...
    IMX135MIPI_write_cmos_sensor(0x0405,0x11);
    ...
    //Size setting
    //Address,value);
    IMX135MIPI_write_cmos_sensor(0x0340,0x05);
    IMX135MIPI_write_cmos_sensor(0x0341,0x20);
    IMX135MIPI_write_cmos_sensor(0x0342,0x11);
    IMX135MIPI_write_cmos_sensor(0x0343,0xDC);
    IMX135MIPI_write_cmos_sensor(0x0344,0x00);
    IMX135MIPI_write_cmos_sensor(0x0345,0x40);
    IMX135MIPI_write_cmos_sensor(0x0346,0x01);
    IMX135MIPI_write_cmos_sensor(0x0347,0x9C);
    IMX135MIPI_write_cmos_sensor(0x0348,0x10);
    IMX135MIPI_write_cmos_sensor(0x0349,0x2F);
    IMX135MIPI_write_cmos_sensor(0x034A,0x0A);
    IMX135MIPI_write_cmos_sensor(0x034B,0x93);
    IMX135MIPI_write_cmos_sensor(0x034C,0x07);
    IMX135MIPI_write_cmos_sensor(0x034D,0x80);
    IMX135MIPI_write_cmos_sensor(0x034E,0x04);
    IMX135MIPI_write_cmos_sensor(0x034F,0x38);
    ...
    IMX135MIPI_write_cmos_sensor(0x0354,0x07);
    IMX135MIPI_write_cmos_sensor(0x0355,0xF8);
    IMX135MIPI_write_cmos_sensor(0x0356,0x04);
    IMX135MIPI_write_cmos_sensor(0x0357,0x7C);
    IMX135MIPI_write_cmos_sensor(0x301D,0x30);
    IMX135MIPI_write_cmos_sensor(0x3310,0x07);
    IMX135MIPI_write_cmos_sensor(0x3311,0x80);
    IMX135MIPI_write_cmos_sensor(0x3312,0x04);
    IMX135MIPI_write_cmos_sensor(0x3313,0x38);
    IMX135MIPI_write_cmos_sensor(0x331C,0x04);
    IMX135MIPI_write_cmos_sensor(0x331D,0xB0);
    IMX135MIPI_write_cmos_sensor(0x4084,0x07);
    IMX135MIPI_write_cmos_sensor(0x4085,0x80);
    IMX135MIPI_write_cmos_sensor(0x4086,0x04);
    IMX135MIPI_write_cmos_sensor(0x4087,0x38);
...
{	
  ...
  //PLL setting 
	IMX135MIPI_write_cmos_sensor(0x0100,0x00);// STREAM STop
#if defined(IMX135_PREVIEW_60FPS)
    //Clock Setting
    //Address,value,
 #if 1
    IMX135MIPI_write_cmos_sensor(0x011E,0x18);
    ...
    //Size setting
    //Address,value);
    IMX135MIPI_write_cmos_sensor(0x0340,0x06);
    IMX135MIPI_write_cmos_sensor(0x0341,0x26);
    IMX135MIPI_write_cmos_sensor(0x0342,0x11);
    IMX135MIPI_write_cmos_sensor(0x0343,0xDC);
    IMX135MIPI_write_cmos_sensor(0x0344,0x00);
    IMX135MIPI_write_cmos_sensor(0x0345,0x40);
    IMX135MIPI_write_cmos_sensor(0x0346,0x00);
    IMX135MIPI_write_cmos_sensor(0x0347,0x20);
    IMX135MIPI_write_cmos_sensor(0x0348,0x10);
    IMX135MIPI_write_cmos_sensor(0x0349,0x2F);
    IMX135MIPI_write_cmos_sensor(0x034A,0x0C);
    IMX135MIPI_write_cmos_sensor(0x034B,0x13);
    IMX135MIPI_write_cmos_sensor(0x034C,0x07);
    IMX135MIPI_write_cmos_sensor(0x034D,0x80);
    IMX135MIPI_write_cmos_sensor(0x034E,0x05);
    IMX135MIPI_write_cmos_sensor(0x034F,0xA0);
    IMX135MIPI_write_cmos_sensor(0x0350,0x00);
    IMX135MIPI_write_cmos_sensor(0x0351,0x00);
    IMX135MIPI_write_cmos_sensor(0x0352,0x00);
    IMX135MIPI_write_cmos_sensor(0x0353,0x00);
    IMX135MIPI_write_cmos_sensor(0x0354,0x07);
    IMX135MIPI_write_cmos_sensor(0x0355,0xF8);
    IMX135MIPI_write_cmos_sensor(0x0356,0x05);
    IMX135MIPI_write_cmos_sensor(0x0357,0xFA);
    IMX135MIPI_write_cmos_sensor(0x301D,0x30);
    IMX135MIPI_write_cmos_sensor(0x3310,0x07);
    IMX135MIPI_write_cmos_sensor(0x3311,0x80);
    IMX135MIPI_write_cmos_sensor(0x3312,0x05);
    IMX135MIPI_write_cmos_sensor(0x3313,0xA0);
    IMX135MIPI_write_cmos_sensor(0x331C,0x04);
    IMX135MIPI_write_cmos_sensor(0x331D,0xB0);
    IMX135MIPI_write_cmos_sensor(0x4084,0x07);
    IMX135MIPI_write_cmos_sensor(0x4085,0x80);
    IMX135MIPI_write_cmos_sensor(0x4086,0x05);
    IMX135MIPI_write_cmos_sensor(0x4087,0xA0);
    IMX135MIPI_write_cmos_sensor(0x4400,0x00);
    //Global Timing Setting
    //Address,value,
    ...
    //Address,value,
    IMX135MIPI_write_cmos_sensor(0x0202,0x06);
    IMX135MIPI_write_cmos_sensor(0x0203,0x22);
    //Gain Setting
    //Address,value,
    IMX135MIPI_write_cmos_sensor(0x0205,0x00);
    IMX135MIPI_write_cmos_sensor(0x020E,0x01);
                                                ...
                                                MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData)
{
    ...
    pSensorInfo->SensorResetDelayCount=2;//5
    ...
    pSensorInfo->VideoDelayFrame = 3; //5
