...
//#define IMX135_VIDEO_60FPS
//#define IMX135_PREVIEW_60FPS
...
#define IMX135MIPI_REAL_PV_WIDTH				(1920-8)//2000//(2104-8)//2000//(2104-8)//-80///2//(1600)
#define IMX135MIPI_REAL_PV_HEIGHT				(1440-8)//1500//(1184-6)//1500//(1560-6)//-60//2//(1200)
...
#define IMX135MIPI_REAL_VIDEO_WIDTH				(1920-8)//(2104-8)//(2104-8)//1920//-8//1920//2104-160//1920-8//2104-8//1920-8
#define IMX135MIPI_REAL_VIDEO_HEIGHT			(1080-8)//(1560-8)//(1184-6)//1080//-6//1080//1184-90//1080-6//1184-6//1080-6
#else
#define IMX135MIPI_REAL_VIDEO_WIDTH				(2104-8)//(2104-8)//(2104-8)//1920//-8//1920//2104-160//1920-8//2104-8//1920-8
#define IMX135MIPI_REAL_VIDEO_HEIGHT			(1560-8)//(1560-8)//(1184-6)//1080//-6//1080//1184-90//1080-6//1184-6//1080-6
#endif
...
#define IMX135MIPI_PV_FRAME_LENGTH_LINES						(1570)//(1640)//(2640)	
#define SENSOR_PREVIEW_FRAMERATE								(60*10)
#define SENSOR_PREVIEW_PCLK										(432000000)

#else
#define IMX135MIPI_PV_LINE_LENGTH_PIXELS 						(4572)
#define IMX135MIPI_PV_FRAME_LENGTH_LINES						(1640)//(1640)//(2640)	
#define SENSOR_PREVIEW_FRAMERATE								(30*10)
#define SENSOR_PREVIEW_PCLK										(231270000)
...
#define IMX135MIPI_VIDEO_FRAME_LENGTH_LINES						(1312)//(1640)
#define SENSOR_VIDEO_FRAMERATE									(60*10)
#define SENSOR_VIDEO_PCLK										(360000000)
#else
#define IMX135MIPI_VIDEO_LINE_LENGTH_PIXELS 					(4572)
#define IMX135MIPI_VIDEO_FRAME_LENGTH_LINES						(1640)//(1640)
#define SENSOR_VIDEO_FRAMERATE									(30*10)
#define SENSOR_VIDEO_PCLK										(231270000)
#endif
...
#define SENSOR_CAPTURE_FRAMERATE								(24*10)
#define SENSOR_CAPTURE_PCLK										(348000000)
#else
#define IMX135MIPI_FULL_LINE_LENGTH_PIXELS 						(5456)
#define IMX135MIPI_FULL_FRAME_LENGTH_LINES			            (3146)
#define SENSOR_CAPTURE_FRAMERATE								(15*10)
#define SENSOR_CAPTURE_PCLK										(259200000)
#endif
