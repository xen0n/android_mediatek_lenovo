...
/*Lenovo-sw caoyi1 modify for alston_tdd A808t ps threshold value 2014-05-08 start*/
    .ps_threshold_high = 218,//65535
    .ps_threshold_low = 123,//0
/*Lenovo-sw caoyi1 modify for alston_tdd A808t ps threshold value  2014-05-08 end*/
};
