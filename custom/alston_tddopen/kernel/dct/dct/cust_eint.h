...
#define CUST_EINT_LTE_WDT_NUM              5
#define CUST_EINT_LTE_WDT_DEBOUNCE_CN      1
#define CUST_EINT_LTE_WDT_TYPE							CUST_EINTF_TRIGGER_LOW
#define CUST_EINT_LTE_WDT_DEBOUNCE_EN      CUST_EINT_DEBOUNCE_ENABLE
...
#define CUST_EINT_LTE_SDIO_NUM              7
#define CUST_EINT_LTE_SDIO_DEBOUNCE_CN      0
#define CUST_EINT_LTE_SDIO_TYPE							CUST_EINTF_TRIGGER_LOW
#define CUST_EINT_LTE_SDIO_DEBOUNCE_EN      CUST_EINT_DEBOUNCE_DISABLE

#define CUST_EINT_GYRO_NUM              10
...
#define CUST_EINT_IRQ_NFC_NUM              74
