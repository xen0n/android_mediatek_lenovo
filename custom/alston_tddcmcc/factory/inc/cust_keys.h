...
/* lenovo-sw chuyq 4.17.2014 change start: for lenovo keypad layout */
...
#define CUST_KEY_RIGHT		KEY_POWER

#define CUST_KEY_CONFIRM	KEY_HOMEPAGE
#define CUST_KEY_BACK		KEY_BACK
/* lenovo-sw chuyq 4.17.2014 change end: for lenovo keypad layout */
