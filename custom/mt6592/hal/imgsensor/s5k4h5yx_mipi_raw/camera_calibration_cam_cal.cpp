...
UINT32 DoCamCalSingleLsc(INT32 CamcamFID, UINT32 start_addr, UINT32 BlockSize, UINT32* pGetSensorCalData)
{
  ...
  else
  {
    ...
    else
    {
      ...
      if(pCamCalData->SingleLsc.LscTable.Data[BlockSize-1]==0xff &&
              pCamCalData->SingleLsc.LscTable.Data[BlockSize-2]==0x00 &&
              pCamCalData->SingleLsc.LscTable.Data[BlockSize-3]==0x02 &&
              pCamCalData->SingleLsc.LscTable.Data[BlockSize-4]==0x01)
      {
#if 1
        ...
        for(Count=0; Count<95; Count++)
          for(Count1=0; Count1<4; Count1++)
            pCamCalData->SingleLsc.LscTable.MtkLcsData.CapTable[(Count)*4+Count1] = 
              pCamCalData->SingleLsc.LscTable.Data[BlockSize-69-Count*4-Count1];
#endif
        /*
