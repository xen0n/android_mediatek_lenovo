...
static const CALIBRATION_LAYOUT_STRUCT CalLayoutTbl[MAX_CALIBRATION_LAYOUT_NUM]=
{
	...
	{//CALIBRATION_LAYOUT_SENSOR_OTP
		0x00000003, 0x00000094, CAM_CAL_SINGLE_OTP_DATA,
		{		
			...
			{0x00000001, 0x00003b04, 0x0000000E, DoCamCal2AGain}, //CAMERA_CAM_CAL_DATA_3A_GAIN
			{0x00000000, 0x00000000, 0x00000000, DoCamCal3DGeo}  //CAMERA_CAM_CAL_DATA_3D_GEO
		}
	}
};
...
static int CamCalGetAWBGain(u16* rGain, u16* gGain, u16* bGain, u8* otpData, u16 bufSize)
{
	...
	//2.get awb data
	*rGain = (*(otpData+5)<<8)|(*(otpData+6));
	*bGain = (*(otpData+7)<<8)|(*(otpData+8));
	*gGain = (*(otpData+9)<<8)|(*(otpData+10));
	for(i=5;i<=10;i++)
...
*
*******************************************************************************/
UINT32 IMX214_CAM_CALGetCalData(UINT32* pGetSensorCalData)
{	
    UCHAR cBuf[128] = "/dev/";	
    UCHAR HeadID[5] = "NONE";	
    UINT32 result = CAM_CAL_ERR_NO_DEVICE;
