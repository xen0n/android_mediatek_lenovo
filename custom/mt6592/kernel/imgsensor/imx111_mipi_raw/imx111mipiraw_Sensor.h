...
#define IMX111MIPI_REAL_VIDEO_WIDTH				1600
#define IMX111MIPI_REAL_VIDEO_HEIGHT			1200
...
#define IMX111MIPI_VIDEO_LINE_LENGTH_PIXELS 					(3536)
#define IMX111MIPI_VIDEO_FRAME_LENGTH_LINES						(1254)	
