...
#if defined(OV5648MIPI_USE_AWB_OTP)
...
#define RG_TYPICAL 0x17D//0x175  //golden sample R/G ratio
#define BG_TYPICAL 0x164//0x16D  //golden sample B/G ratio
