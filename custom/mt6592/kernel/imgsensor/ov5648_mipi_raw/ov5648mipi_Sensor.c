...
#define OV5648MIPI_TEST_PATTERN_CHECKSUM (0x3d80c0a)
...
int OV5648MIPI_check_awb_gain(){
	...
	R_Gain_H=OV5648MIPI_read_cmos_sensor(0x5186);
	R_Gain_L=OV5648MIPI_read_cmos_sensor(0x5187);
	G_Gain_H=OV5648MIPI_read_cmos_sensor(0x5188);
	G_Gain_L=OV5648MIPI_read_cmos_sensor(0x5189);
	B_Gain_H=OV5648MIPI_read_cmos_sensor(0x518a);
	B_Gain_L=OV5648MIPI_read_cmos_sensor(0x518b);

	SENSORDB("R_Gain_H=0x%02x R_Gain_L=0x%02x G_Gain_H=0x%02x G_Gain_L=0x%02x B_Gain_H=0x%02x B_Gain_L=0x%02x",
					R_Gain_H,R_Gain_L,G_Gain_H,G_Gain_L,B_Gain_H,B_Gain_L);
}
kal_uint16 OV5648MIPI_check_otp(kal_uint16 index)
{
   kal_uint16 flag,i,rg,bg;
   kal_uint16 rg_ratio,bg_ratio;
   if(index==1)
   	{
	  ...
	  Delay(10);
	   ...
	   rg_ratio=OV5648MIPI_read_cmos_sensor(0x3d07);
	   bg_ratio=OV5648MIPI_read_cmos_sensor(0x3d08);
    }
   else if(index==2)
   	{
       OV5648MIPI_write_cmos_sensor(0X3D84,0XC0);
	  ...
	  Delay(10);
	   ...
	   OV5648MIPI_write_cmos_sensor(0X3D81,0X01);
	  Delay(10);
	   rg_ratio=OV5648MIPI_read_cmos_sensor(0x3d00);
	   bg_ratio=OV5648MIPI_read_cmos_sensor(0x3d01);
    }  
   else if(index==3)
   	{
       OV5648MIPI_write_cmos_sensor(0X3D84,0XC0);
	   ...
	   rg_ratio=OV5648MIPI_read_cmos_sensor(0x3d09);
	   bg_ratio=OV5648MIPI_read_cmos_sensor(0x3d0a);      
   }
   SENSORDB("%s  index=%d, flag=0x%04x ,rg_ratio=0x%04x, bg_ratio=0x%04x\r\n",
   			__func__,index,flag,rg_ratio,bg_ratio);   
...
kal_uint16 OV5648MIPI_read_otp(kal_uint16 index,struct OV5648MIPI_otp_struct *otp_ptr)
{
   kal_uint16 i,temp;
   if(index==1)
   	{
	   ...
	   (*otp_ptr).rg_ratio=(kal_uint16)(((kal_uint16)OV5648MIPI_read_cmos_sensor(0X3d07))<<2)+(kal_uint16)((((kal_uint16)temp)>>6)&0x03);
	   (*otp_ptr).bg_ratio=(kal_uint16)(((kal_uint16)OV5648MIPI_read_cmos_sensor(0X3d08))<<2)+(kal_uint16)((((kal_uint16)temp)>>4)&0x03);
	   (*otp_ptr).light_rg=(kal_uint16)(((kal_uint16)OV5648MIPI_read_cmos_sensor(0X3d0c))<<2)+(kal_uint16)((((kal_uint16)temp)>>2)&0x03);
	   (*otp_ptr).light_bg=(kal_uint16)(((kal_uint16)OV5648MIPI_read_cmos_sensor(0X3d0d))<<2)+(kal_uint16)(((kal_uint16)temp)&0x03);
	   ...
	   (*otp_ptr).rg_ratio=(kal_uint16)(((kal_uint16)OV5648MIPI_read_cmos_sensor(0X3d00))<<2)+(kal_uint16)((((kal_uint16)temp)>>6)&0x03);
	   (*otp_ptr).bg_ratio=(kal_uint16)(((kal_uint16)OV5648MIPI_read_cmos_sensor(0X3d01))<<2)+(kal_uint16)((((kal_uint16)temp)>>4)&0x03);
	   (*otp_ptr).light_rg=(kal_uint16)(((kal_uint16)OV5648MIPI_read_cmos_sensor(0X3d05))<<2)+(kal_uint16)((((kal_uint16)temp)>>2)&0x03);
	   (*otp_ptr).light_bg=(kal_uint16)(((kal_uint16)OV5648MIPI_read_cmos_sensor(0X3d06))<<2)+(kal_uint16)(((kal_uint16)temp)&0x03);
	   ...
	   (*otp_ptr).rg_ratio=(kal_uint16)(((kal_uint16)OV5648MIPI_read_cmos_sensor(0X3d09))<<2)+(kal_uint16)((((kal_uint16)temp)>>6)&0x03);
	   (*otp_ptr).bg_ratio=(kal_uint16)(((kal_uint16)OV5648MIPI_read_cmos_sensor(0X3d0a))<<2)+(kal_uint16)((((kal_uint16)temp)>>4)&0x03);
	   (*otp_ptr).light_rg=(kal_uint16)(((kal_uint16)OV5648MIPI_read_cmos_sensor(0X3d0e))<<2)+(kal_uint16)((((kal_uint16)temp)>>2)&0x03);
	   (*otp_ptr).light_bg=(kal_uint16)(((kal_uint16)OV5648MIPI_read_cmos_sensor(0X3d0f))<<2)+(kal_uint16)(((kal_uint16)temp)&0x03);
	...
	SENSORDB("%s  index=%d\r\n,module_integrator_id=0x%04x\r\n,lens_id=0x%04x\r\n,rg_ratio=0x%04x\r\n,bg_ratio=0x%04x\r\n,light_rg=0x%04x\r\n,light_bg=0x%04x\r\n,user_data[0]=0x%04x\r\n,user_data[1]=0x%04x\r\n",
				__func__,index,(*otp_ptr).module_integrator_id,(*otp_ptr).lens_id,(*otp_ptr).rg_ratio,(*otp_ptr).bg_ratio,
				(*otp_ptr).light_rg,(*otp_ptr).light_bg,(*otp_ptr).user_data[0],(*otp_ptr).user_data[1]);	 	
	return 0;

}

kal_uint16 OV5648MIPI_update_awb_gain(kal_uint32 R_G,kal_uint32 G_G,kal_uint32 B_G)
{

  if(R_G>0x400)
  	{
      OV5648MIPI_write_cmos_sensor(0X5186,R_G>>8);
	  OV5648MIPI_write_cmos_sensor(0X5187,R_G&0x00ff);     
    }
    if(G_G>0x400)
  	{
      OV5648MIPI_write_cmos_sensor(0X5188,G_G>>8);
	  OV5648MIPI_write_cmos_sensor(0X5189,G_G&0x00ff);     
    }
	  if(B_G>0x400)
  	{
      OV5648MIPI_write_cmos_sensor(0X518a,B_G>>8);
	  OV5648MIPI_write_cmos_sensor(0X518b,B_G&0x00ff);     
    }
	return 0;
}
...
kal_uint16 OV5648MIPI_update_otp()
{
   struct OV5648MIPI_otp_struct current_otp;
   kal_uint16 i;
   kal_uint16 otp_index;
   kal_uint16 temp;
   kal_uint16 R_G,G_G,B_G,G_G_R,G_G_B;
   kal_uint16 rg,bg;
   ...
   if(i>3)
   	{
   	SENSORDB("sunliang new no valid wb otp data");
      return 1; //no valid wb otp data;
   }
   SENSORDB("sunliang new otp index=%d\r\n",otp_index);
   OV5648MIPI_read_otp(otp_index,&current_otp);
   if(current_otp.light_rg==0)
   {
   	SENSORDB("current_otp.light_rg==0\r\n");
  ...
  if(current_otp.light_bg==0)
   {
   	SENSORDB("current_otp.light_bg==0\r\n");
   ...
   SENSORDB("bg=0x%04x rg=0x%04x\r\n",bg,rg);
   if(bg<BG_Ratio_Typical)
   {
   	SENSORDB("bg<BG_Ratio_Typical\r\n");
      if(rg<RG_Ratio_Typical)
      	{
      		SENSORDB("rg<RG_Ratio_Typical\r\n");
         	G_G=0x400;
		 B_G=0x400*BG_Ratio_Typical/bg;
		 R_G=0X400*RG_Ratio_Typical/rg;
	  }
	    else
      	{
      		SENSORDB("rg>=RG_Ratio_Typical\r\n");
         	R_G=0x400;
		 G_G=0x400*rg/RG_Ratio_Typical;
		 B_G=G_G*RG_Ratio_Typical/bg;
	  }
   }
   else
   {
         ...
         if(rg<RG_Ratio_Typical)
      	  {
      	  	SENSORDB("rg<RG_Ratio_Typical\r\n");
         	B_G=0x400;
		 G_G=0x400*bg/BG_Ratio_Typical;;
		 R_G=G_G*RG_Ratio_Typical/rg;
	  }
	   else
      	  {
      	  	SENSORDB("rg>=RG_Ratio_Typical\r\n");
         	G_G_B=0x400*bg/BG_Ratio_Typical;
		 G_G_R=0x400*rg/RG_Ratio_Typical;
		 if(G_G_B>G_G_R)
		 {
		 	   SENSORDB("G_G_B>G_G_R\r\n");
               	   B_G=0X400;
			   G_G=G_G_B;
			   R_G=G_G*RG_Ratio_Typical/rg;
		 ...
		 else
		 {
			 ...
			 R_G=0X400;
			 G_G=G_G_R;
			 B_G=G_G*BG_Ratio_Typical/bg;
		    }
	  }
   }
   SENSORDB("R_G=0x%04x,G_G=0x%04x,B_G=0x%04x\r\n",R_G,G_G,B_G);
   SENSORDB("before check\r\n");
   OV5648MIPI_check_awb_gain();
  OV5648MIPI_update_awb_gain(R_G,G_G,B_G);
  SENSORDB("after check\r\n");
  OV5648MIPI_check_awb_gain();
  SENSORDB("*********************%s end*********************\r\n",__func__);
  return 0;
...
void OV5648MIPI_Set_Mirror_Flip(kal_uint8 image_mirror)
{
    ...
    OV5648MIPI_sensor.mirror=image_mirror;
                      ...
                      MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
    ...
    OV5648MIPI_Preview_Setting();
    OV5648MIPI_Set_Mirror_Flip(IMAGE_HV_MIRROR);
    spin_lock(&ov5648mipi_drv_lock);
