...
#define IMX132MIPI_TEST_PATTERN_CHECKSUM (0x1617c60f)
...
UINT32 IMX132MIPISetTestPatternMode(kal_bool bEnable)
{
    SENSORDB("bEnable=%d\n", bEnable);
	if(bEnable) 
	{
	
        IMX132MIPI_write_cmos_sensor(0x3282,0x01);
        IMX132MIPI_write_cmos_sensor(0x0600,0x00);
        IMX132MIPI_write_cmos_sensor(0x0601,0x02);
	}
	else        
	{
		IMX132MIPI_write_cmos_sensor(0x0601,0x00);	
	}
    return ERROR_NONE;
}
							 ...
							 UINT8 *pFeaturePara,UINT32 *pFeatureParaLen)
{
	...
	switch (FeatureId)
	{
		...
		case SENSOR_FEATURE_SET_TEST_PATTERN:
            IMX132MIPISetTestPatternMode((BOOL)*pFeatureData16);
            break;
		...
		case SENSOR_FEATURE_GET_TEST_PATTERN_CHECKSUM_VALUE://for factory mode auto testing 			
            *pFeatureReturnPara32= IMX132MIPI_TEST_PATTERN_CHECKSUM;
			*pFeatureParaLen=4; 							
			break;
		default:
			break;
