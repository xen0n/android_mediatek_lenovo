...
static struct IMX135MIPI_sensor_STRUCT IMX135MIPI_sensor=
{
    ...
    SENSOR_PREVIEW_PCLK,                      //kal_uint32 pv_pclk;             //Preview Pclk                                   
    SENSOR_VIDEO_PCLK,                          //kal_uint32 video_pclk;                //video Pclk                               
    SENSOR_CAPTURE_PCLK,                      //kal_uint32 cp_pclk;             //Capture Pclk                                   
...
#define SENSORDB(fmt, arg...) printk( "[IMX135MIPIRaw@6592] "  fmt, ##arg)
#define RETAILMSG(x,...)
#define TEXT
...
#define IMX135_REG(reg,data)    ((reg) >>8) & 0xFF,((reg) >>0) & 0xFF,((data) >>0) & 0xFF

static kal_uint8* pDmaBuf=NULL;
static dma_addr_t dmaHandle;
static kal_uint8 imx135_init_cmd[] = 
{
    IMX135_REG(0x0103, 0x01),
    IMX135_REG(0x0101, 0x00),
    IMX135_REG(0x0105, 0x01),
    IMX135_REG(0x0110, 0x00),
    IMX135_REG(0x0220, 0x01),
    IMX135_REG(0x3302, 0x11),
    IMX135_REG(0x3833, 0x20),
    IMX135_REG(0x3893, 0x00),
    IMX135_REG(0x3906, 0x08),
    IMX135_REG(0x3907, 0x01),
    IMX135_REG(0x391B, 0x01),
    IMX135_REG(0x3C09, 0x01),
    IMX135_REG(0x600A, 0x00),
    IMX135_REG(0x3008, 0xB0),
    IMX135_REG(0x320A, 0x01),
    IMX135_REG(0x320D, 0x10),
    IMX135_REG(0x3216, 0x2E),
    IMX135_REG(0x322C, 0x02),
    IMX135_REG(0x3409, 0x0C),
    IMX135_REG(0x340C, 0x2D),
    IMX135_REG(0x3411, 0x39),
    IMX135_REG(0x3414, 0x1E),
    IMX135_REG(0x3427, 0x04),
    IMX135_REG(0x3480, 0x1E),
    IMX135_REG(0x3484, 0x1E),
    IMX135_REG(0x3488, 0x1E),
    IMX135_REG(0x348C, 0x1E),
    IMX135_REG(0x3490, 0x1E),
    IMX135_REG(0x3494, 0x1E),
    IMX135_REG(0x3511, 0x8F),
    IMX135_REG(0x364F, 0x2D),

    //quality

    //defect forrection recommended setting

    IMX135_REG(0x380A, 0x00),
    IMX135_REG(0x380B, 0x00),
    IMX135_REG(0x4103, 0x00),

    //color artifact recommended setting

    IMX135_REG(0x4243, 0x9A),
    IMX135_REG(0x4330, 0x01),
    IMX135_REG(0x4331, 0x90),
    IMX135_REG(0x4332, 0x02),
    IMX135_REG(0x4333, 0x58),
    IMX135_REG(0x4334, 0x03),
    IMX135_REG(0x4335, 0x20),
    IMX135_REG(0x4336, 0x03),
    IMX135_REG(0x4337, 0x84),
    IMX135_REG(0x433C, 0x01),
    IMX135_REG(0x4340, 0x02),
    IMX135_REG(0x4341, 0x58),
    IMX135_REG(0x4342, 0x03),
    IMX135_REG(0x4343, 0x52),


    /////Moire reduction parameter setting

    IMX135_REG(0x4364, 0x0B),
    IMX135_REG(0x4368, 0x00),
    IMX135_REG(0x4369, 0x0F),
    IMX135_REG(0x436A, 0x03),
    IMX135_REG(0x436B, 0xA8),
    IMX135_REG(0x436C, 0x00),
    IMX135_REG(0x436D, 0x00),
    IMX135_REG(0x436E, 0x00),
    IMX135_REG(0x436F, 0x06),

    //CNR parameter setting

    IMX135_REG(0x4281, 0x21),
    IMX135_REG(0x4282, 0x18),
    IMX135_REG(0x4283, 0x04),
    IMX135_REG(0x4284, 0x08),
    IMX135_REG(0x4287, 0x7F),
    IMX135_REG(0x4288, 0x08),
    IMX135_REG(0x428B, 0x7F),
    IMX135_REG(0x428C, 0x08),
    IMX135_REG(0x428F, 0x7F),
    IMX135_REG(0x4297, 0x00),
    IMX135_REG(0x4298, 0x7E),
    IMX135_REG(0x4299, 0x7E),
    IMX135_REG(0x429A, 0x7E),
    IMX135_REG(0x42A4, 0xFB),
    IMX135_REG(0x42A5, 0x7E),
    IMX135_REG(0x42A6, 0xDF),
    IMX135_REG(0x42A7, 0xB7),
    IMX135_REG(0x42AF, 0x03),

    // ARNR Parameter setting
    IMX135_REG(0x4207, 0x03),
    IMX135_REG(0x4216, 0x08),
    IMX135_REG(0x4217, 0x08),

    //DLC Parammeter setting
    IMX135_REG(0x4218, 0x00),
    IMX135_REG(0x421B, 0x20),
    IMX135_REG(0x421F, 0x04),
    IMX135_REG(0x4222, 0x02),
    IMX135_REG(0x4223, 0x22),
    IMX135_REG(0x422E, 0x54),
    IMX135_REG(0x422F, 0xFB),
    IMX135_REG(0x4230, 0xFF),
    IMX135_REG(0x4231, 0xFE),
    IMX135_REG(0x4232, 0xFF),
    IMX135_REG(0x4235, 0x58),
    IMX135_REG(0x4236, 0xF7),
    IMX135_REG(0x4237, 0xFD),
    IMX135_REG(0x4239, 0x4E),
    IMX135_REG(0x423A, 0xFC),
    IMX135_REG(0x423B, 0xFD),

    //HDR


    //LSC setting
    IMX135_REG(0x452A, 0x02),


    //white balance setting
    IMX135_REG(0x0712, 0x01),
    IMX135_REG(0x0713, 0x00),
    IMX135_REG(0x0714, 0x01),
    IMX135_REG(0x0715, 0x00),
    IMX135_REG(0x0716, 0x01),
    IMX135_REG(0x0717, 0x00),
    IMX135_REG(0x0718, 0x01),
    IMX135_REG(0x0719, 0x00),

    //shading setting
    IMX135_REG(0x4500, 0x1F)
};

static kal_uint8 imx135_video_cmd[] = 
{
    // STREAM STOP
    IMX135_REG(0x0100,0x00),
    //PLL setting
    IMX135_REG(0x011E,0x18),   
    IMX135_REG(0x011F,0x00),   
    IMX135_REG(0x0301,0x05),   
    IMX135_REG(0x0303,0x01),   
    IMX135_REG(0x0305,0x0B),   
    IMX135_REG(0x0309,0x05),   
    IMX135_REG(0x030B,0x01),   
    IMX135_REG(0x030C,0x01),   
    IMX135_REG(0x030D,0x09),   
    IMX135_REG(0x030E,0x01),   
    IMX135_REG(0x3A06,0x11),   

    //Mode setting
    IMX135_REG(0x0108,0x03),   
    IMX135_REG(0x0112,0x0A),   
    IMX135_REG(0x0113,0x0A),   
    IMX135_REG(0x0381,0x01),   
    IMX135_REG(0x0383,0x01),   
    IMX135_REG(0x0385,0x01),   
    IMX135_REG(0x0387,0x01),   
    IMX135_REG(0x0390,0x01),   
    IMX135_REG(0x0391,0x22),   
    IMX135_REG(0x0392,0x00),   
    IMX135_REG(0x0401,0x00),   
    IMX135_REG(0x0404,0x00),   
    IMX135_REG(0x0405,0x10),   
    IMX135_REG(0x4082,0x01),   
    IMX135_REG(0x4083,0x01),   
    IMX135_REG(0x7006,0x04),

    //Optionnal function setting
    IMX135_REG(0x0700,0x00),   
    IMX135_REG(0x3A63,0x00),
    IMX135_REG(0x4100,0xF8),   
    IMX135_REG(0x4203,0xFF),   
    IMX135_REG(0x4344,0x00),   
    IMX135_REG(0x441C,0x01),

    //Size setting
    IMX135_REG(0x0340,(IMX135MIPI_VIDEO_FRAME_LENGTH_LINES>>8)&0xFF),   
    IMX135_REG(0x0341,(IMX135MIPI_VIDEO_FRAME_LENGTH_LINES>>0)&0xFF),    
    IMX135_REG(0x0342,(IMX135MIPI_VIDEO_LINE_LENGTH_PIXELS>>8)&0xFF), 
    IMX135_REG(0x0343,(IMX135MIPI_VIDEO_LINE_LENGTH_PIXELS>>0)&0xFF),
    IMX135_REG(0x0344,0x00),
    IMX135_REG(0x0345,0x00),
    IMX135_REG(0x0346,0x00),
    IMX135_REG(0x0347,0x00),
    IMX135_REG(0x0348,0x10),
    IMX135_REG(0x0349,0x6F),
    IMX135_REG(0x034A,0x0C),
    IMX135_REG(0x034B,0x2F),
    IMX135_REG(0x034C,0x08),
    IMX135_REG(0x034D,0x38),
    IMX135_REG(0x034E,0x06),
    IMX135_REG(0x034F,0x18),
    IMX135_REG(0x0350,0x00),   
    IMX135_REG(0x0351,0x00),   
    IMX135_REG(0x0352,0x00), 
    IMX135_REG(0x0353,0x00),
    IMX135_REG(0x0354,0x08),
    IMX135_REG(0x0355,0x38),
    IMX135_REG(0x0356,0x06),
    IMX135_REG(0x0357,0x18),    
    IMX135_REG(0x301D,0x30),   
    IMX135_REG(0x3310,0x08),   
    IMX135_REG(0x3311,0x38),   
    IMX135_REG(0x3312,0x06),   
    IMX135_REG(0x3313,0x18),   
    IMX135_REG(0x331C,0x04),   
    IMX135_REG(0x331D,0xAB),   
    IMX135_REG(0x4084,0x00),   
    IMX135_REG(0x4085,0x00),   
    IMX135_REG(0x4086,0x00),   
    IMX135_REG(0x4087,0x00),   
    IMX135_REG(0x4400,0x00),

    //global timing setting
    IMX135_REG(0x0830,0x6F),   
    IMX135_REG(0x0831,0x27),  
    IMX135_REG(0x0832,0x4F),   
    IMX135_REG(0x0833,0x2F), 
    IMX135_REG(0x0834,0x2F),   
    IMX135_REG(0x0835,0x2F), 
    IMX135_REG(0x0836,0x9F),   
    IMX135_REG(0x0837,0x37),
    IMX135_REG(0x0839,0x1F),
    IMX135_REG(0x083A,0x17),   
    IMX135_REG(0x083B,0x02), 

    // integration time setting
    IMX135_REG(0x0202,0x06),
    IMX135_REG(0x0203,0x64),

    //gain setting
    IMX135_REG(0x0205,0x00),   
    IMX135_REG(0x020E,0x01),   
    IMX135_REG(0x020F,0x00),   
    IMX135_REG(0x0210,0x01),   
    IMX135_REG(0x0211,0x00),   
    IMX135_REG(0x0212,0x01),   
    IMX135_REG(0x0213,0x00),   
    IMX135_REG(0x0214,0x01),   
    IMX135_REG(0x0215,0x00),

#if 0
    //hdr setting
    IMX135_REG(0x0230,0x00),   
    IMX135_REG(0x0231,0x00),     
    IMX135_REG(0x0233,0x00),
    IMX135_REG(0x0234,0x00),   
    IMX135_REG(0x0235,0x40),
    IMX135_REG(0x0236,0x00),   
    IMX135_REG(0x0238,0x00),   
    IMX135_REG(0x0239,0x04),
    IMX135_REG(0x023B,0x00),   
    IMX135_REG(0x023C,0x00),
    IMX135_REG(0x33B0,0x04),   
    IMX135_REG(0x33B1,0x00),
    IMX135_REG(0x33B3,0X00),   
    IMX135_REG(0x33B4,0X01),
    IMX135_REG(0x3800,0X00),
#endif
    IMX135_REG(0x3A43,0X01),
    IMX135_REG(0x0100,0x01)// STREAM START
};

static kal_uint8 imx135_preview_cmd[] = 
{
    // STREAM STOP
    IMX135_REG(0x0100,0x00),
    //PLL setting
    ...
    //Size setting
    IMX135_REG(0x0340,(IMX135MIPI_PV_FRAME_LENGTH_LINES>>8)&0xFF),   
    IMX135_REG(0x0341,(IMX135MIPI_PV_FRAME_LENGTH_LINES>>0)&0xFF),   
    IMX135_REG(0x0342,(IMX135MIPI_PV_LINE_LENGTH_PIXELS>>8)&0xFF),
    IMX135_REG(0x0343,(IMX135MIPI_PV_LINE_LENGTH_PIXELS>>0)&0xFF),
    IMX135_REG(0x0344,0x00),
    IMX135_REG(0x0345,0x00),
    IMX135_REG(0x0346,0x00),
    IMX135_REG(0x0347,0x00),
...
static kal_uint8 imx135_capture_cmd[] = 
{
    // STREAM STOP
    IMX135_REG(0x0100,0x00),
    //ClockSetting
    ...
    IMX135_REG(0x0301,0x05),
    IMX135_REG(0x0303,0x01),
    IMX135_REG(0x0305,0x0C),
    IMX135_REG(0x0309,0x05),
    IMX135_REG(0x030B,0x01),
    IMX135_REG(0x030C,0x01),
    IMX135_REG(0x030D,0xB3),
    IMX135_REG(0x030E,0x01),
    IMX135_REG(0x3A06,0x11),
    ...
    IMX135_REG(0x0385,0x01),
    IMX135_REG(0x0387,0x01),
    IMX135_REG(0x0390,0x00),
    IMX135_REG(0x0391,0x11),
    IMX135_REG(0x0392,0x00),
    IMX135_REG(0x0401,0x00),
    IMX135_REG(0x0404,0x00),
    IMX135_REG(0x0405,0x10),
    ...
    //Sizesetting
    IMX135_REG(0x0340,(IMX135MIPI_FULL_FRAME_LENGTH_LINES>>8)&0xFF),   
    IMX135_REG(0x0341,(IMX135MIPI_FULL_FRAME_LENGTH_LINES>>0)&0xFF),   
    IMX135_REG(0x0342,(IMX135MIPI_FULL_LINE_LENGTH_PIXELS>>8)&0xFF),
    IMX135_REG(0x0343,(IMX135MIPI_FULL_LINE_LENGTH_PIXELS>>0)&0xFF),
    IMX135_REG(0x0344,0x00),
    IMX135_REG(0x0345,0x00),
    IMX135_REG(0x0346,0x00),
    IMX135_REG(0x0347,0x00),
    ...
    IMX135_REG(0x034A,0x0C),
    IMX135_REG(0x034B,0x2F),
    IMX135_REG(0x034C,0x10),
    IMX135_REG(0x034D,0x70),
    IMX135_REG(0x034E,0x0C),
    IMX135_REG(0x034F,0x30),
    IMX135_REG(0x0350,0x00),
    IMX135_REG(0x0351,0x00),
    IMX135_REG(0x0352,0x00),
    IMX135_REG(0x0353,0x00),
    IMX135_REG(0x0354,0x10),
    IMX135_REG(0x0355,0x70),
    IMX135_REG(0x0356,0x0C),
    IMX135_REG(0x0357,0x30),
    IMX135_REG(0x301D,0x30),
    IMX135_REG(0x3310,0x10),
    IMX135_REG(0x3311,0x70),
    IMX135_REG(0x3312,0x0C),
    IMX135_REG(0x3313,0x30),
    IMX135_REG(0x331C,0x01),
    IMX135_REG(0x331D,0x68),
    IMX135_REG(0x4084,0x00),
    IMX135_REG(0x4085,0x00),
    IMX135_REG(0x4086,0x00),
    IMX135_REG(0x4087,0x00),
    ...
    //GlobalTimingSetting
    IMX135_REG(0x0830,0x7F),
    IMX135_REG(0x0831,0x37),
    IMX135_REG(0x0832,0x67),
    IMX135_REG(0x0833,0x3F),
    IMX135_REG(0x0834,0x3F),
    IMX135_REG(0x0835,0x47),
    IMX135_REG(0x0836,0xDF),
    IMX135_REG(0x0837,0x47),
    IMX135_REG(0x0839,0x1F),
    IMX135_REG(0x083A,0x17),
    IMX135_REG(0x083B,0x02),

    //IntegrationTimeSetting
    IMX135_REG(0x0202,0x0C),
    IMX135_REG(0x0203,0x46),
...
void IMX135MIPI_multi_write_cmos_sensor(u8 *pData, u16 lens)
{
    ...
    if(pDmaBuf == NULL)
    {
        SENSORDB("pDmaBuf == NULL\n");
        return;
    }

    totalCnt = lens;
    if(totalCnt%transac_len)
        SENSORDB("IMX135MIPI_multi_write ARRAY_SIZE ERROR\n");
    transfer_len = totalCnt / transac_len;
    len = (transfer_len<<8)|transac_len;    
    memcpy(pDmaBuf, pData, totalCnt );   
    dmaHandle = dma_map_single(NULL, pDmaBuf, 1024, DMA_TO_DEVICE); 
    iMultiWriteReg(dmaHandle, len, IMX135MIPI_WRITE_ID); 
    SENSORDB("IMX135MIPI_multi_write,totalCnt=%d,transac_len=%d,\n",totalCnt,transac_len);
...
//    SENSORDB("[IMX135MIPI_SetGain ] RegisterGain:%d\n", iReg);
    ...
    IMX135MIPI_write_cmos_sensor(0x0104, 0);
//    SENSORDB("[IMX135MIPI_SetGain ] SetGain:%d;RegisterGain:%d\n", iGain, iReg);
...
static void IMX135MIPI_Sensor_Init(void)
{
    ...
    IMX135MIPI_multi_write_cmos_sensor(imx135_init_cmd, ARRAY_SIZE(imx135_init_cmd)); 
...
void VideoFullSizeSetting(void)//16:9   6M
{
    ...
    IMX135MIPI_multi_write_cmos_sensor(imx135_video_cmd, ARRAY_SIZE(imx135_video_cmd)); 
...
{    
    ...
    IMX135MIPI_multi_write_cmos_sensor(imx135_preview_cmd, ARRAY_SIZE(imx135_preview_cmd)); 
    SENSORDB("PreviewSetting exit\n");
}

void CaptureSetting(void)
{
    SENSORDB("CaptureSetting enter:\n");
    IMX135MIPI_multi_write_cmos_sensor(imx135_capture_cmd, ARRAY_SIZE(imx135_capture_cmd)); 
    SENSORDB("CaptureSetting exit\n");
}
...
//sensorid = IMX135MIPI_SENSOR_ID;
    ...
    pDmaBuf = (kal_uint8*)kmalloc(1024, GFP_KERNEL);
    if(pDmaBuf == NULL)
    {
        SENSORDB("kmalloc Fail\n"); 
                                                ...
                                                MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
    ...
    {   
        ...
        IMX135MIPISetFlipMirror(SENSOR_FLIP_MIRROR);
                                                ...
                                                MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData)
{
    ...
    pSensorInfo->SensorResetDelayCount=5;//5
    pSensorInfo->SensorOutputDataFormat=SENSOR_OUTPUT_FORMAT;
    ...
    pSensorInfo->VideoDelayFrame = 5; //5
...
UINT32 IMX135MIPIGetDefaultFramerateByScenario(MSDK_SCENARIO_ID_ENUM scenarioId, MUINT32 *pframeRate) 
{
    ...
    switch (scenarioId) {
        case MSDK_SCENARIO_ID_CAMERA_PREVIEW:
            *pframeRate = SENSOR_PREVIEW_FRAMERATE;
            break;
        case MSDK_SCENARIO_ID_VIDEO_PREVIEW:
            *pframeRate = SENSOR_VIDEO_FRAMERATE;
            break;
        case MSDK_SCENARIO_ID_CAMERA_CAPTURE_JPEG:
        case MSDK_SCENARIO_ID_CAMERA_ZSD:
            *pframeRate = SENSOR_CAPTURE_FRAMERATE;
            break;        
        case MSDK_SCENARIO_ID_CAMERA_3D_PREVIEW: //added
        case MSDK_SCENARIO_ID_CAMERA_3D_VIDEO:
        case MSDK_SCENARIO_ID_CAMERA_3D_CAPTURE: //added   
