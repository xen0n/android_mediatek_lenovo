...
//	@@ RES_4208x3120 24fps
	...
	#define OV13850_IMAGE_SENSOR_FULL_WIDTH					4208-16 //(4200-8)	
	#define OV13850_IMAGE_SENSOR_FULL_HEIGHT				3120-16 //(3100-6)
	...
	//OV13850_CAP_18FPS
	#define OV13850MIPI_CAPTURE_CLK 	(480000000)
	...
	#define OV13850_FULL_PERIOD_PIXEL_NUMS					(6010)//(4800)
	#define OV13850_FULL_PERIOD_LINE_NUMS					(3328)


	#define OV13850_PV_PERIOD_PIXEL_NUMS					(2400)//(4800)
	#define OV13850_PV_PERIOD_LINE_NUMS						3328//(2664) //(1664):pclk 240M; (2664) for pclk 384;(3328) for pclk 480	 

	#define OV13850_VIDEO_PERIOD_PIXEL_NUMS 			(2400)//(4800) 
