...
#define OV13850_RG_Ratio_Typical			(0X136)
#define OV13850_BG_Ratio_Typical			(0X129)
...
int read_otp_wb(int index, struct otp_struct *otp_ptr)
{
	...
	(*otp_ptr).typical_rg_ratio=OV13850_RG_Ratio_Typical;
	(*otp_ptr).typical_bg_ratio= OV13850_BG_Ratio_Typical;
