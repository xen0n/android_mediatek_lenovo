...
typedef struct
{
	...
	#define OV12830MIPI_CAPTURE_CLK 	(240000000)
	#else
	#ifdef OV12830_CAP_24FPS
	#define OV12830MIPI_CAPTURE_CLK 	(324000000)
	#else
	...
	#ifdef OV12830_CAP_24FPS
	#define OV12830_FULL_PERIOD_PIXEL_NUMS					(0x1150)
    #else
	#define OV12830_FULL_PERIOD_PIXEL_NUMS					(0x1100)
	#endif
	
	#ifdef OV12830_CAP_18FPS
	#define OV12830_FULL_PERIOD_LINE_NUMS					(3064)
	#else
	#ifdef OV12830_CAP_24FPS
	#define OV12830_FULL_PERIOD_LINE_NUMS					(3044)
	#else
