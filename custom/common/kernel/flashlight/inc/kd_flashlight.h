...
#define FLASH_IOC_LOW_POWER_DUTY _IOR(FLASHLIGHT_MAGIC, 185, int)
#define FLASH_IOC_LOW_POWER_PROTECT_START _IOR(FLASHLIGHT_MAGIC, 190, int)
#define FLASH_IOC_LOW_POWER_PROTECT_END _IOR(FLASHLIGHT_MAGIC, 195, int)
