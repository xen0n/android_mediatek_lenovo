...
static hw_module_info hw_info_2 = {
	.type = HW_MODULE_TYPE_MAIN_CAMERA,
	.id = 0x2235,
	.priority = HW_MODULE_PRIORITY_MAIN_CAMERA,
	.name = "GC2235_RAW",
	.vendor = "GC",
	.more = "200W"
};
...
#if defined(TYD_PRO_HV7_CHERRY_PH)
	GC2235_SetMirrorFlip(GC2235_IMAGE_V_MIRROR);
#else
...
#ifdef _HW_MODULE_INFO_
    #ifdef CAMERA_DUAL_CAMERA_MAIN_OR_SUB
    if(0x01 == CAMERA_DUAL_CAMERA_MAIN_OR_SUB) //main camera //gaohuadong
    hw_module_info_add(&hw_info_2);
    else //gaohuadong
    #endif
...
static UINT32 GC2235SetTestPatternMode(kal_bool bEnable)
{
    SENSORDB("[GC2235SetTestPatternMode]test pattern bEnable:=%d\n",bEnable);
    if(bEnable)
    {
        GC2235_write_cmos_sensor(0xfe, 0x00);
        GC2235_write_cmos_sensor(0x03, 0x05);
        GC2235_write_cmos_sensor(0x04, 0x4b); 
        GC2235_write_cmos_sensor(0x18, 0x16);
        GC2235_write_cmos_sensor(0x40, 0x20);
        GC2235_write_cmos_sensor(0x44, 0x00);
        GC2235_write_cmos_sensor(0x45, 0x00);
        GC2235_write_cmos_sensor(0x46, 0x00);
        GC2235_write_cmos_sensor(0x47, 0x00);
        GC2235_write_cmos_sensor(0x48, 0x00);
        GC2235_write_cmos_sensor(0x49, 0x00);
        GC2235_write_cmos_sensor(0x4a, 0x00);
        GC2235_write_cmos_sensor(0x4b, 0x00);
        GC2235_write_cmos_sensor(0x54, 0x00);
        GC2235_write_cmos_sensor(0x55, 0x00);
        GC2235_write_cmos_sensor(0x56, 0x00);
        GC2235_write_cmos_sensor(0x57, 0x00);
        GC2235_write_cmos_sensor(0x58, 0x00);
        GC2235_write_cmos_sensor(0x59, 0x00);
        GC2235_write_cmos_sensor(0x5a, 0x00);
        GC2235_write_cmos_sensor(0x5b, 0x00);
        GC2235_write_cmos_sensor(0xc4, 0x00);
        GC2235_write_cmos_sensor(0xc5, 0x00);
        GC2235_write_cmos_sensor(0xc6, 0x00);
        GC2235_write_cmos_sensor(0xc7, 0x00);
        GC2235_write_cmos_sensor(0xc8, 0x00);
        GC2235_write_cmos_sensor(0xc9, 0x00);
        GC2235_write_cmos_sensor(0xca, 0x00);
        GC2235_write_cmos_sensor(0xcb, 0x00);
        GC2235_write_cmos_sensor(0xd4, 0x00);
        GC2235_write_cmos_sensor(0xd5, 0x00);
        GC2235_write_cmos_sensor(0xd6, 0x00);
        GC2235_write_cmos_sensor(0xd7, 0x00);
        GC2235_write_cmos_sensor(0xd8, 0x00);
        GC2235_write_cmos_sensor(0xd9, 0x00);
        GC2235_write_cmos_sensor(0xda, 0x00);
        GC2235_write_cmos_sensor(0xdb, 0x00);
        GC2235_write_cmos_sensor(0xb0, 0x40);
        GC2235_write_cmos_sensor(0xb3, 0x40);
        GC2235_write_cmos_sensor(0xb4, 0x40);
        GC2235_write_cmos_sensor(0xb5, 0x40);
        GC2235_write_cmos_sensor(0x8c, 0x12);
        Sleep(50);
        //mdelay(50);
        //run_test_potten=1;
    }
