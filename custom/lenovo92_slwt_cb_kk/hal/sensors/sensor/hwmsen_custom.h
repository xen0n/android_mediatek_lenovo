...
/*Lenovo-sw caoyi1 modify for sensorlist 2014-04-04 start */
#ifdef CUSTOM_KERNEL_ACCELEROMETER
	#define ACCELEROMETER 		"BMA222EF 3-axis Accelerometer"
	#define ACCELEROMETER_VENDER 	"Bosch"
#endif

#ifdef CUSTOM_KERNEL_ALSPS
	#define PROXIMITY 		"EPL2182  Proximity Sensor"
	#define PROXIMITY_VENDER 	"Elan"
	#define LIGHT 			"EPL2182 Light Sensor"
	#define LIGHT_VENDER 		"Elan"
#endif
/*Lenovo-sw caoyi1 modify for sensorlist 2014-04-04 end */
