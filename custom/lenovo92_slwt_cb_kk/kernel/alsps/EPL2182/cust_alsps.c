...
/*Lenovo-sw caoyi1 modify for ps threshold value 2014-04-16 start*/
    .ps_threshold_high = 98,//65535
    .ps_threshold_low = 47,//0
/*Lenovo-sw caoyi1 modify for ps threshold value  2014-04-16 end*/
};
